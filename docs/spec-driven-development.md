...
Rendered page: https://magpie.apache.org/docs/spec-driven-development/

Source: https://github.com/apache/magpie/blob/main/docs/spec-driven-development.md
...
[`tools/spec-loop/`](https://github.com/apache/magpie/tree/main/tools/spec-loop/). It is how this framework can be
...
- **Specs** ([`tools/spec-loop/specs/`](https://github.com/apache/magpie/tree/main/tools/spec-loop/specs/)) — a
...
- **The implementation plan**
  ([`tools/spec-loop/IMPLEMENTATION_PLAN.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/IMPLEMENTATION_PLAN.md))
...
[`tools/spec-loop/AGENTS.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/AGENTS.md) (repo map,
validation commands, branch and hard-limit rules) layered on top of the
repository-wide [`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md). Each build iteration reads
only the spec and source files relevant to its one work item, so a fresh
context never drowns in the whole tree.

## Specs are not RFCs

The framework already has [`docs/rfcs/`](https://github.com/apache/magpie/tree/main/docs/rfcs/) — normative principle
...
[`tools/spec-loop/specs/README.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/specs/README.md).
...
[`.claude/settings.json`](https://github.com/apache/magpie/blob/main/.claude/settings.json) — they require a human
...
layered (see [`docs/rfcs/RFC-AI-0004.md`](/docs/rfcs/rfc-ai-0004) for the
