...
| **License** | Apache-2.0 ([§18](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#18-contributions-land-under-apache-license-20)) | yours | the author's |
...
| **Install** | part of the snapshot | committed override | you wire it in deliberately — never auto-fetched ([§14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-snapshot-plus-override-never-vendored-copies)) |
...
5. **Add an eval** ([§9](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#9-eval-is-a-release-blocking-discipline))
