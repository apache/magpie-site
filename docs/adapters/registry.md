...
| Agent harness | Claude Code, [Codex](/docs/adapters/codex) `experimental` ([#313](https://github.com/apache/magpie/issues/313)), [Gemini CLI](/docs/adapters/gemini) `experimental` ([#314](https://github.com/apache/magpie/issues/314)), [Local LLM (Ollama / llama.cpp / vLLM)](/docs/adapters/local-llm) ([#315](https://github.com/apache/magpie/issues/315)), [Cursor](/docs/adapters/cursor) ([#316](https://github.com/apache/magpie/issues/316)), [Goose](/docs/adapters/goose) `guide only` ([#319](https://github.com/apache/magpie/issues/319)), [Aider](/docs/adapters/aider) `guide only` ([#317](https://github.com/apache/magpie/issues/317)), [GitHub Copilot](/docs/adapters/copilot) `guide only` ([#318](https://github.com/apache/magpie/issues/318)) | Amazon Q [#320](https://github.com/apache/magpie/issues/320)–OpenHands [#322](https://github.com/apache/magpie/issues/322) |
| Security cross-ref | [`tools/osv`](https://github.com/apache/magpie/tree/main/tools/osv/) | — |
