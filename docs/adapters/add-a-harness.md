...
Rendered page: https://magpie.apache.org/docs/adapters/add-a-harness/

Source: https://github.com/apache/magpie/blob/main/docs/adapters/add-a-harness.md
...
[tool-adapter authoring guide](/docs/adapters/authoring) — that guide adds a
...
[`skills/setup/agents.md`](https://github.com/apache/magpie/blob/main/skills/setup/agents.md). Add one row:
...
See [`tools/agent-isolation/README.md`](https://github.com/apache/magpie/blob/main/tools/agent-isolation/README.md)
...
- `SPEC_LOOP_EFFORT` mapped when the CLI has a reasoning-effort knob
  ...
  [`tools/spec-loop/specs/spec-loop-runner.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/specs/spec-loop-runner.md));
...
[`tools/agent-isolation/README.md`](https://github.com/apache/magpie/blob/main/tools/agent-isolation/README.md)).
...
- [`skills/setup/agents.md`](https://github.com/apache/magpie/blob/main/skills/setup/agents.md) — the
  agent-target registry (single source of truth for symlink paths).
- [`tools/symlink-lint/`](https://github.com/apache/magpie/tree/main/tools/symlink-lint/) — enforces relay
  symlink correctness.
- [`tools/agent-guard/`](https://github.com/apache/magpie/tree/main/tools/agent-guard/) — the action guard
  core and per-harness adapters.
- [`tools/agent-isolation/`](https://github.com/apache/magpie/tree/main/tools/agent-isolation/) — the
  clean-environment launcher (OS-level complement to the agent hook).
- [`tools/spec-loop/loop.sh`](https://github.com/apache/magpie/blob/main/tools/spec-loop/loop.sh) and
  `lib.sh` — the spec-loop runner with per-harness invocation profiles.
- [`docs/vendor-neutrality.md`](/docs/vendor-neutrality) § Agentic
  runtime — the open tracking issues per runtime and the neutrality
  rationale.
- [`docs/adapters/authoring.md`](/docs/adapters/authoring) — the analogous recipe
