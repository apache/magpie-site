...
Rendered page: https://magpie.apache.org/docs/extending/

Source: https://github.com/apache/magpie/blob/main/docs/extending.md
...
|---|---|---|
| **Skill** | a workflow the agent follows | [`PRINCIPLES.md` §15](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#15-skills-are-the-unit-of-authorship), [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) |
| **Skill source** | a trusted external repo a skill/family is *pulled* from | [`docs/skill-sources/`](/docs/skill-sources/readme), [`RFC-AI-0006`](/docs/rfcs/rfc-ai-0006) |
| **Tool / tool adapter** | the only layer that knows a vendor — a backend behind a capability contract | [vendor-neutrality § Tool adapters](/docs/vendor-neutrality#tool-adapters), [`adapters/authoring.md`](/docs/adapters/authoring) |
| **Capability contract** | the stable verb set a skill depends on; the seam adapters plug into | [`tools/cve-tool/`](https://github.com/apache/magpie/tree/main/tools/cve-tool/) and siblings |
| **Organization** | governance vocabulary + backend bundle + identity, shared by an org's projects | [`organizations/README.md`](https://github.com/apache/magpie/blob/main/organizations/README.md) |
| **Project config** | one adopter's concrete values | [`projects/_template/`](https://github.com/apache/magpie/tree/main/projects/_template/) |
| **User config** | one person's preferences (handle, governance membership, local clone paths) | [`AGENTS.md` § user.md](https://github.com/apache/magpie/blob/main/AGENTS.md#usermd-resolution-order) |
...
|---|---|---|---|---|
| **In-tree** (upstream) | a PR into `apache/magpie` | the framework, to every adopter | Apache-2.0 ([§18](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#18-contributions-land-under-apache-license-20)) | the extension is broadly useful — other projects share the backend/org |
...
([§14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-snapshot-plus-override-never-vendored-copies)):
...
another repo and the [registry](/docs/adapters/registry) lists it for
discovery.
...
- **Skills** — framework skills come from the snapshot; project tweaks
  ...
  *pulled in* from a **trusted external source** — a `skills/<name>/source.md`
  ...
  referenced (see [`PRINCIPLES.md` §14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-snapshot-plus-override-never-vendored-copies)
  and [`docs/skill-sources/`](/docs/skill-sources/readme)).
- **Tools / adapters** — selected per capability in
  ...
  the choice. See [`adapters/authoring.md`](/docs/adapters/authoring).
- **Organizations** — `organization: <org>` in `project.md` resolves to
  an in-tree [`organizations/<org>/`](https://github.com/apache/magpie/blob/main/organizations/README.md) first;
...
[`setup-override-upstream`](https://github.com/apache/magpie/blob/main/skills/setup-override-upstream/SKILL.md).
...
projects point at it. See [`organizations/README.md`](https://github.com/apache/magpie/blob/main/organizations/README.md).
...
- a **skill** — [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) +
  [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md);
- a **tool/adapter or organization** —
  [`adapters/authoring.md`](/docs/adapters/authoring);
- an **override you have been running** —
  [`setup-override-upstream`](https://github.com/apache/magpie/blob/main/skills/setup-override-upstream/SKILL.md).

## See also

- [`docs/vendor-neutrality.md`](/docs/vendor-neutrality) — the skills / tools / capabilities / organizations architecture.
- [`docs/adapters/registry.md`](/docs/adapters/registry) — discovery index of in-tree and external adapters.
- [`organizations/README.md`](https://github.com/apache/magpie/blob/main/organizations/README.md) — the organization entity and its resolution order.
