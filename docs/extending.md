...
|---|---|---|
| **Skill** | a workflow the agent follows | [`PRINCIPLES.md` §14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-skills-are-the-unit-of-authorship), [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) |
...
|---|---|---|---|---|
| **In-tree** (upstream) | a PR into `apache/magpie` | the framework, to every adopter | Apache-2.0 ([§17](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#17-contributions-land-under-apache-license-20)) | the extension is broadly useful — other projects share the backend/org |
...
([§13](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-snapshot-plus-override-never-vendored-copies)):
...
- **Skills** — framework skills come from the snapshot; project tweaks
  ...
  *pulled in* from a **trusted external source** — a `skills/<name>/source.md`
  ...
  referenced (see [`PRINCIPLES.md` §13](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-snapshot-plus-override-never-vendored-copies)
