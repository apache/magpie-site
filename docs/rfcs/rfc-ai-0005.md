...
Rendered page: https://magpie.apache.org/docs/rfcs/rfc-ai-0005/

Source: https://github.com/apache/magpie/blob/main/docs/rfcs/RFC-AI-0005.md
...
| **tool capability** | tools / adapters | *what interface/contract does the backend provide?* | this RFC + the adapter [registry](/docs/adapters/registry) |
...
The *contract* rows are exactly the seams an [adapter](/docs/vendor-neutrality#tool-adapters)
...
table as the adapter [registry](/docs/adapters/registry)).
