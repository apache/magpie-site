...
- [`docs/setup/install-recipes.md`](/docs/quick-start/other-install-methods) — the
  fetch recipes that gain the sparse variant.
- [`PRINCIPLES.md` §14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md) — the snapshot-plus-override
