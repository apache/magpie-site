...
- **Cross-party correlation stays scoped**
  ([PRINCIPLES §16](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#16-tracker-identifiers-are-public-safe-tracker-contents-are-not)).
...
- [`PRINCIPLES.md` §16](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#16-tracker-identifiers-are-public-safe-tracker-contents-are-not) — tracker contents stay access-gated; the clause per-hop dedup scoping is measured against.
