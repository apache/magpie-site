...
framework [install recipes](/docs/setup/install-recipes) verbatim — `git
...
- [`docs/setup/install-recipes.md`](/docs/setup/install-recipes) — the fetch/verify recipes reused per source.
