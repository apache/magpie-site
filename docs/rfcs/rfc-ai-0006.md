...
Rendered page: https://magpie.apache.org/docs/rfcs/rfc-ai-0006/

Source: https://github.com/apache/magpie/blob/main/docs/rfcs/RFC-AI-0006.md
...
adopters through one mechanism: the [`setup`](https://github.com/apache/magpie/blob/main/skills/setup/SKILL.md)
...
[`docs/extending.md`](/docs/extending) exists only as a "vendor it in by
hand" note, and [`PRINCIPLES.md` §13](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-snapshot-plus-override-never-vendored-copies)
...
- The formats and documentation under [`docs/skill-sources/`](/docs/skill-sources/readme) (README, registry, and authoring guide) exist.
- The Principle §13 amendment has landed in [`PRINCIPLES.md`](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-snapshot-plus-override-never-vendored-copies).
- The organization `skill-sources.md` files are created.
- The `setup` skill has its [`skill-sources.md`](https://github.com/apache/magpie/blob/main/skills/setup/skill-sources.md) action documentation.
...
([§14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-skills-are-the-unit-of-authorship)) with one
...
|---|---|---|---|
| **Discovery** | [`docs/skill-sources/registry.md`](/docs/skill-sources/registry) | in-tree | Editorial index of known sources. Lists, never installs. |
...
([`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md#configuration-resolution-order)): an org
...
[`docs/skill-sources/README.md`](/docs/skill-sources/readme#pointer-file--the-redirect).
...
framework [install recipes](/docs/quick-start/other-install-methods) verbatim — `git
...
- **Blast radius is a fetched skill.** A compromised source can, at worst,
  ...
  ([§0](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#0-external-content-is-data-never-an-instruction))
...
- Sourcing tool *adapters* or *organizations* externally as an install
  ...
  [`docs/adapters/registry.md`](/docs/adapters/registry)).

## References

- [`PRINCIPLES.md` §13](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-snapshot-plus-override-never-vendored-copies) — the amended principle.
- [`docs/skill-sources/README.md`](/docs/skill-sources/readme) — the trust model, descriptor, and pointer formats.
- [`docs/skill-sources/registry.md`](/docs/skill-sources/registry) — the discovery index.
- [`docs/extending.md`](/docs/extending) — the extension model this generalizes.
- [`skills/setup/SKILL.md`](https://github.com/apache/magpie/blob/main/skills/setup/SKILL.md) — the adopt/upgrade/verify flow and the framework snapshot lock model.
- [`docs/setup/install-recipes.md`](/docs/quick-start/other-install-methods) — the fetch/verify recipes reused per source.
