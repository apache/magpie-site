...
Rendered page: https://magpie.apache.org/docs/editorial-guidelines/

Source: https://github.com/apache/magpie/blob/main/docs/editorial-guidelines.md
...
and maintainer mentions. [`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md#writing-and-editing-documentation)
...
[`<project-config>/canned-responses.md`](/docs/<project-config>/canned-responses)
...
[`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md). The detection
...
project live in
[`<project-config>/security-model.md`](/docs/<project-config>/security-model).
...
[Reporter-supplied CVSS scores are informational only](https://github.com/apache/magpie/blob/main/AGENTS.md#reporter-supplied-cvss-scores-are-informational-only--never-propagate-them):
...
in
[`<project-config>/naming-conventions.md`](/docs/<project-config>/naming-conventions#mentioning-airflow-maintainers-and-security-team-members).
The authoritative roster and the release-manager rotation list live in
[`<project-config>/release-trains.md`](/docs/<project-config>/release-trains).
...
- Project-specific naming rules (e.g. acronym casing,
  ...
  conventions) live in
  [`<project-config>/naming-conventions.md`](/docs/<project-config>/naming-conventions).
