...
Rendered page: https://magpie.apache.org/docs/education/choosing-models/

Source: https://github.com/apache/magpie/blob/main/docs/education/choosing-models.md
...
The [eval-driven-development](/docs/education/eval-driven-development) page shows this in
...
(PRINCIPLE 1). See the
[privacy routing pattern](/docs/education/pattern-catalogue#pattern-5--privacy-routing-clean-the-text-before-the-model-sees-it).
...
- **[How to work with agents](/docs/education/working-with-agents)** is the conversation this
  model sits underneath; a less capable model simply needs more steering.
- **[How to write your first skill](/docs/education/your-first-skill)** comes next. Once you
  can write a skill, the model choice attaches to a concrete piece of work.
- **[Eval-driven development](/docs/education/eval-driven-development)** is how you actually
  compare models, including the judge model that grades prose output.
- **[PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md)**: PRINCIPLE 1 (privacy and sandbox by
