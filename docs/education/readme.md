...
Rendered page: https://magpie.apache.org/docs/education/readme/

Source: https://github.com/apache/magpie/blob/main/docs/education/README.md
...
use Magpie at all, read [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md) and
[PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md) first.
...
|---|---|---|
| 1 | [What agents are](/docs/education/what-agents-are) | What an agent actually is (a model, tools, a loop, and context) and why its answers can vary |
| 2 | [Working with agents](/docs/education/working-with-agents) | Driving an agent through a conversation: how to ask, how to steer, when to confirm |
| 3 | [Choosing models](/docs/education/choosing-models) | Choosing a model by capability, speed, and cost, and letting evals decide |
| 4 | [Your first skill](/docs/education/your-first-skill) | Writing and merging your own skill, the main work in Magpie |
| 5 | [Writing safe skills](/docs/education/writing-safe-skills) | Authoring patterns that hold the data-not-instructions and sandbox principles in every skill you write |
| 6 | [Debugging a skill](/docs/education/debugging-skills) | Reading the audit log, reproducing failures with the eval harness, and isolating prompt vs tool vs model problems |
| 7 | [Writing portable skills](/docs/education/portable-skills) | Authoring skills that work for any project and any model, using placeholders and capability floors |
| 8 | [Eval-driven development](/docs/education/eval-driven-development) | How to judge whether an agent's answers are good, when the answers can change |
| 9 | [Agentic and autonomous work](/docs/education/agentic-work) | Letting an agent run a whole task, and the guardrails that make that safe |
| 10 | [English as a programming language](/docs/education/english-as-code) | The mindset underneath it all: the words you write *are* the program |
| 11 | [How to contribute to Magpie](/docs/education/contributing) | Giving your work back: contributing skills, patterns, and docs to the framework |

**Supporting references for the skill-writing steps (4–7):**

| Page | What it is |
|---|---|
| [Pattern catalogue](/docs/education/pattern-catalogue) | Ready-to-copy skill, prompt, and tool-use patterns, with notes on what worked and what did not |
| [Tutorials](/docs/education/tutorials) | A hands-on lab: build a small skill, give it an eval suite, and run it, in about 90 minutes |
...
- **[magpie-write-skill](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md)** is
  the full reference for writing a skill, for someone who already knows the
  basic shape of one. Step 4, [your first skill](/docs/education/your-first-skill), is the
  gentle start that gets you to that point.
- **[tools/privacy-llm/pii.md](https://github.com/apache/magpie/blob/main/tools/privacy-llm/pii.md)** lists how
  personal data is removed before it reaches a model. The
  [pattern catalogue](/docs/education/pattern-catalogue) shows *how* and *why* to use it,
  with examples.
- **[docs/rfcs/RFC-AI-0004.md](/docs/rfcs/rfc-ai-0004)** is the decision that
  started this stream. It points here through
  [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md).
...
the model. See [`ai-tutors/README.md`](https://github.com/apache/magpie/blob/main/ai-tutors/README.md) for
