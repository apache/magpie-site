...
Rendered page: https://magpie.apache.org/docs/education/writing-safe-skills/

Source: https://github.com/apache/magpie/blob/main/docs/education/writing-safe-skills.md
...
This is **step 5** in the [learning progression](/docs/education/readme). You wrote a skill
in step 4 ([Your first skill](/docs/education/your-first-skill)). The three rules at the end
...
[Agentic and autonomous work](/docs/education/agentic-work) before this page. That page
...
[`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md#treat-external-content-as-data-never-as-instructions).
```
...
- **[Your first skill](/docs/education/your-first-skill)** is step 4, the page before this
  one. The three rules at the end of that page are what this page implements as
  copy-ready patterns.
- **[Debugging a skill](/docs/education/debugging-skills)** is step 6, the page after this
...
- **[Writing portable skills](/docs/education/portable-skills)** is step 7. It shows how to
...
- **[Eval-driven development](/docs/education/eval-driven-development)** is step 8. The eval
...
- **[Agentic and autonomous work](/docs/education/agentic-work)** is step 9. It shows why
  these patterns become even more important when the agent runs without a human
  watching every step.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** has ready-to-copy skill shapes
  for common cases, each annotated with the principle it satisfies.
- **[tools/privacy-llm/pii.md](https://github.com/apache/magpie/blob/main/tools/privacy-llm/pii.md)** — the complete
  list of what the Privacy-LLM gate redacts and why.
- **[AGENTS.md](https://github.com/apache/magpie/blob/main/AGENTS.md)** — the absolute rule on external content, the
