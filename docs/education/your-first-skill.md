...
Rendered page: https://magpie.apache.org/docs/education/your-first-skill/

Source: https://github.com/apache/magpie/blob/main/docs/education/your-first-skill.md
...
the [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md)
...
- A working checkout of the `<framework>` repository, and a setup that can run
  `uv` commands (see [CONTRIBUTING.md](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md)).
...
The [pattern catalogue](/docs/education/pattern-catalogue) has ready-to-copy
examples. The [eval-driven-development](/docs/education/eval-driven-development) page goes
...
- A broken link — check that every `[text](https://github.com/apache/magpie/tree/main/docs/education/path)` points to a real file.
...
[`tools/skill-evals/README.md`](https://github.com/apache/magpie/blob/main/tools/skill-evals/README.md) for the full
...
See the [eval-driven-development](/docs/education/eval-driven-development) page for
...
This is **step 4** in the [learning progression](/docs/education/readme). The natural next
step is to make the skill safe to run against outside text:

- **[Writing safe skills](/docs/education/writing-safe-skills)** — step 5: the authoring
...
- **[Debugging a skill](/docs/education/debugging-skills)** — step 6: reading the audit log,
...
- **[Writing portable skills](/docs/education/portable-skills)** — step 7: authoring skills
...
- **[Eval-driven development](/docs/education/eval-driven-development)** — step 8: how to judge
...
- **[Agentic and autonomous work](/docs/education/agentic-work)** — step 9: once a skill is
  written, tested, and safe, this is how you let it run without watching every step.

Supporting references for skill-writing:

- **[magpie-write-skill](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md)** —
  ...
  walk-through.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** — ready-to-copy skill, prompt,
  and tool-use patterns.
- **[Tutorials](/docs/education/tutorials)** — a hands-on lab that puts steps 4 and 5 into
  practice end to end.
- **[CONTRIBUTING.md](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md)** — the framework's contribution
