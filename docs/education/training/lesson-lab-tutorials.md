...
Rendered page: https://magpie.apache.org/docs/education/training/lesson-lab-tutorials/

Source: https://github.com/apache/magpie/blob/main/docs/education/training/lesson-lab-tutorials.md
...
**Source page:** [Tutorial: build and evaluate a skill](/docs/education/tutorials)
...
**Read** the source page **[Tutorial: build and evaluate a skill](/docs/education/tutorials)**
...
source page **[Tutorial: build and evaluate a skill](/docs/education/tutorials)** in
order:
...
- **[Contributing to the framework](/docs/education/contributing)** — start with the
...
- **[Pattern catalogue](/docs/education/pattern-catalogue)** — copy-pasteable patterns
  for the skill body: data-not-instructions guards, propose-confirm-act steps,
  and placeholder usage.
- **[Eval-driven development](/docs/education/eval-driven-development)** — the design
