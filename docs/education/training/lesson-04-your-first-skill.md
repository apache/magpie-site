...
Rendered page: https://magpie.apache.org/docs/education/training/lesson-04-your-first-skill/

Source: https://github.com/apache/magpie/blob/main/docs/education/training/lesson-04-your-first-skill.md
...
**Source page:** [Your first skill](/docs/education/your-first-skill)
...
Read the source page **[Your first skill](/docs/education/your-first-skill)** from start
...
from the table in [AGENTS.md](https://github.com/apache/magpie/blob/main/AGENTS.md).
...
**[Writing safe skills](/docs/education/writing-safe-skills)** — step 5 of the
