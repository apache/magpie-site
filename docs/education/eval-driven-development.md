...
Rendered page: https://magpie.apache.org/docs/education/eval-driven-development/

Source: https://github.com/apache/magpie/blob/main/docs/education/eval-driven-development.md
...
This is **step 8** in the [learning progression](/docs/education/readme). You wrote a skill in
...
- **[`your-first-skill.md`](/docs/education/your-first-skill)** is step 4; it covers the
...
- **[`writing-safe-skills.md`](/docs/education/writing-safe-skills)** is step 5. The attack
  cases you write in evals (including the prompt-injection fixture) pair
  directly with the patterns it describes.
- **[`debugging-skills.md`](/docs/education/debugging-skills)** is step 6. That page covers
  the debug loop when an eval fails; this one covers designing the evals that
  surface the bug in the first place. They pair.
- **[`portable-skills.md`](/docs/education/portable-skills)** is step 7, the page immediately
...
- **[`agentic-work.md`](/docs/education/agentic-work)** is step 9, the page after this one.
  The eval evidence you build here is exactly what lets a skill run
  autonomously, so evals come first for a reason.
- **[`tools/skill-evals/README.md`](https://github.com/apache/magpie/blob/main/tools/skill-evals/README.md)** is the
  harness reference: every runner flag, the grading modes, and the full case
  format.
- **[`pattern-catalogue.md`](/docs/education/pattern-catalogue)** includes a "test your skill
  with an eval before shipping it" pattern as a ready-to-copy recipe.
- **[PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md)**: PRINCIPLE 8 is the release rule;
