...
Rendered page: https://magpie.apache.org/docs/education/working-with-agents/

Source: https://github.com/apache/magpie/blob/main/docs/education/working-with-agents.md
...
The [previous page](/docs/education/what-agents-are) explained what an agent is. This page is
...
The [pattern catalogue](/docs/education/pattern-catalogue) shows how Magpie's skills write
this rule down so it holds every time.

## Context fills up, so help it along

A session's context is finite (see [what agents are](/docs/education/what-agents-are)). In a
...
- **[What agents are](/docs/education/what-agents-are)** is the concept behind this page: the
  loop, tools, and context you are steering here.
- **[How to use different models](/docs/education/choosing-models)** comes next. The same
  conversation can run on different models, and the choice affects speed, cost,
  and how much steering you need.
- **[How to write your first skill](/docs/education/your-first-skill)** is where a good
  conversation becomes something you can keep and reuse.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** turns the habits here, such as
