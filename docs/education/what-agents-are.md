...
Rendered page: https://magpie.apache.org/docs/education/what-agents-are/

Source: https://github.com/apache/magpie/blob/main/docs/education/what-agents-are.md
...
- **What you put in context steers the answer.** The instructions, the examples,
  ...
  seed of an idea the [English as a programming language](/docs/education/english-as-code)
...
- **[How to work with agents](/docs/education/working-with-agents)** is the next step. Now
  that you know what an agent *is*, that page shows how to actually drive one in
  a conversation and get useful results.
- **[English as a programming language](/docs/education/english-as-code)** develops the idea,
  raised above, that the words you give an agent are the real program.
- **[MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md)** and **[PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md)**
