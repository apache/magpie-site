...
Rendered page: https://magpie.apache.org/docs/education/pattern-catalogue/

Source: https://github.com/apache/magpie/blob/main/docs/education/pattern-catalogue.md
...
[`tools/privacy-llm/pii.md`](https://github.com/apache/magpie/blob/main/tools/privacy-llm/pii.md) and lists the
...
machine. See
[`tools/privacy-llm/pii.md`](https://github.com/apache/magpie/blob/main/tools/privacy-llm/pii.md) for the
...
- [`<sibling-skill>`](/docs/<sibling-skill>/skill) — invoke when
  `<condition the current skill produces>`.
- [`<other-sibling-skill>`](/docs/<other-sibling-skill>/skill) —
  invoke to `<next job>`.
...
[`docs/education/eval-driven-development.md`](/docs/education/eval-driven-development) for
