...
Rendered page: https://magpie.apache.org/docs/education/debugging-skills/

Source: https://github.com/apache/magpie/blob/main/docs/education/debugging-skills.md
...
This is **step 6** in the [learning progression](/docs/education/readme). You wrote a skill
...
- **Eval case (fixture)**: one example input, together with a description of
  ...
  [Eval-driven development](/docs/education/eval-driven-development).
...
- Make the boundary explicit. If a step both reads an issue and classifies it,
  ...
  [Writing safe skills](/docs/education/writing-safe-skills), Pattern 1.)
...
2. If yes, the task is at the model's capability edge. Consider:
   ...
   - Using a more capable model for the failing step (see
     [Choosing models](/docs/education/choosing-models)).
...
- **[Writing safe skills](/docs/education/writing-safe-skills)** is step 5, the page before
  ...
  read.
- **[Writing portable skills](/docs/education/portable-skills)** is step 7, the page after
...
- **[Eval-driven development](/docs/education/eval-driven-development)** is step 8. That page
...
- **[Choosing models](/docs/education/choosing-models)** is step 3. When a failure turns out
  to be a model-capability problem, that page is where to look for guidance on
  which model tier to try next.
- **[Agentic and autonomous work](/docs/education/agentic-work)** is step 9. When no one is
...
- **[tools/skill-evals/README.md](https://github.com/apache/magpie/blob/main/tools/skill-evals/README.md)** — the
  harness reference: runner flags, grading modes, the `case-meta.json` format,
  and the `local-smoke` tag.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** — the patterns named in this
