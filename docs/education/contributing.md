...
Rendered page: https://magpie.apache.org/docs/education/contributing/

Source: https://github.com/apache/magpie/blob/main/docs/education/contributing.md
...
reference is [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md), which you should read in
full before your first patch.

## Words used on this page

New to some of these words? Here is what they mean here. The
[landing page](/docs/education/readme) has a fuller list.
...
fix to an existing skill, a pattern for the [catalogue](/docs/education/pattern-catalogue), or
...
language](/docs/education/english-as-code) page is the mindset; this page is the mechanics.
...
- **Add a pattern.** You found a skill shape that works well; write it up for the
  [pattern catalogue](/docs/education/pattern-catalogue) so others can copy it.
- **Write a new skill.** The biggest of the common first contributions.
  [Your first skill](/docs/education/your-first-skill) is the step-by-step path, and it ends
...
[`docs/spec-driven-development.md`](/docs/spec-driven-development).
...
The short version (the long version is [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md)):

1. **Get set up.** Clone the framework repository and confirm you can run `uv`
   and the validators. See [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md) and
   [`docs/prerequisites.md`](/docs/prerequisites).
...
- Read [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md) end to end before your first
  patch. It is the authoritative process, layout, and dev-loop reference.
- Use the [`magpie-write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) skill
  (`/write-skill`) for the complete skill-authoring checklist.
- Read [`MISSION.md`](https://github.com/apache/magpie/blob/main/MISSION.md) and [`PRINCIPLES.md`](https://github.com/apache/magpie/blob/main/PRINCIPLES.md)
...
- **[Your first skill](/docs/education/your-first-skill)** is the concrete zero-to-merged path
  this page frames; start there for a skill contribution.
- **[English as a programming language](/docs/education/english-as-code)** is the mindset that
  makes contributing to Magpie approachable.
- **[`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md)** is the authoritative contribution
  reference, covering process, repository layout, and the dev loop CI enforces.
- **[`docs/spec-driven-development.md`](/docs/spec-driven-development)** is
