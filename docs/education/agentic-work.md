...
Rendered page: https://magpie.apache.org/docs/education/agentic-work/

Source: https://github.com/apache/magpie/blob/main/docs/education/agentic-work.md
...
of the [earlier pages](/docs/education/working-with-agents) to a task that runs unattended:
...
- **[How to write your first skill](/docs/education/your-first-skill)** and
  **[eval-driven development](/docs/education/eval-driven-development)** are the two steps this
  page depends on: autonomy is what a tested skill unlocks.
- **[How to work with agents](/docs/education/working-with-agents)** is the supervised end of
  the dial this page extends.
- **[English as a programming language](/docs/education/english-as-code)** comes next, and
  names the mindset underneath everything you have now done.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** collects the guardrail patterns
  named here, such as sandbox declarations, propose-confirm-act, and injection
  defence, as copy-ready blocks.
- **[PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md)**: PRINCIPLE 0 (data not instructions),
