...
Rendered page: https://magpie.apache.org/docs/education/tutorials/

Source: https://github.com/apache/magpie/blob/main/docs/education/tutorials.md
...
- A clone of the `<framework>` repository, and a setup that can run `uv` and
  `python3` (see [CONTRIBUTING.md](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md)).
- To have read [`your-first-skill.md`](/docs/education/your-first-skill) once, and skimmed
  [`eval-driven-development.md`](/docs/education/eval-driven-development). This tutorial puts
...
- **[`your-first-skill.md`](/docs/education/your-first-skill)** — the step-by-step reference
  for the mechanics this tutorial drills. Keep it open in another tab.
- **[`eval-driven-development.md`](/docs/education/eval-driven-development)** — the design
  thinking behind Exercises 3 and 4: what to check and how to grade it.
- **[`pattern-catalogue.md`](/docs/education/pattern-catalogue)** — ready-to-copy patterns
