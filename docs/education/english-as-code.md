...
Rendered page: https://magpie.apache.org/docs/education/english-as-code/

Source: https://github.com/apache/magpie/blob/main/docs/education/english-as-code.md
...
- **Test it.** You cannot compile a prompt, but you can run it against examples.
  That is what an [eval suite](/docs/education/eval-driven-development) is: the test suite for
...
- **[How to write your first skill](/docs/education/your-first-skill)** is this idea in
  practice: a skill is a program written in English.
- **[Eval-driven development](/docs/education/eval-driven-development)** is the testing half of
  the discipline, and the reason "it ran once" is not enough.
- **[Pattern catalogue](/docs/education/pattern-catalogue)** is the reusable-code library for
  this language: vetted blocks you compose instead of rewriting.
- **[How to contribute to Magpie](/docs/education/contributing)** is where you put it to work,
