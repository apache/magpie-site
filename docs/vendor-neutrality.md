...
([`PRINCIPLES.md` §10](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#10-vendor-neutrality-is-non-negotiable),
[§4](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#4-project-autonomy-is-the-structural-starting-point))
...
| **Project governance** | ASF PMC, foundation-hosted, single-vendor, informal maintainer group | Modes and thresholds are adopter config; non-ASF adopters are first-class ([`PRINCIPLES.md` §4](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#4-project-autonomy-is-the-structural-starting-point)) |
...
a shortcut ([`PRINCIPLES.md` §13](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#13-the-framework-is-project-agnostic-concrete-names-live-in-adopter-config)).
...
- **Contribute it to Magpie.** Scaffold the adapter against the
  ...
  ([`PRINCIPLES.md` §18](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#18-contributions-land-under-apache-license-20)),
...
- **Link to an adapter defined elsewhere.** You do not have to upstream
  ...
  [`PRINCIPLES.md` §14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-snapshot-plus-override-never-vendored-copies),
...
([`PRINCIPLES.md` §4](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#4-project-autonomy-is-the-structural-starting-point)).
...
- **Eval is a release-blocking discipline**
  ([`PRINCIPLES.md` §9](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#9-eval-is-a-release-blocking-discipline)).
...
- [`PRINCIPLES.md` §10 — Vendor neutrality is non-negotiable](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#10-vendor-neutrality-is-non-negotiable)
- [`PRINCIPLES.md` §4 — Project autonomy is the structural starting point](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#4-project-autonomy-is-the-structural-starting-point)
- [`MISSION.md` § Affordability and vendor neutrality](https://github.com/apache/magpie/blob/main/MISSION.md#affordability-and-vendor-neutrality--the-public-good-commitment)
