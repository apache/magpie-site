...
Rendered page: https://magpie.apache.org/docs/vendor-neutrality/

Source: https://github.com/apache/magpie/blob/main/docs/vendor-neutrality.md
...
([`PRINCIPLES.md` §9](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#9-vendor-neutrality-is-non-negotiable),
[§3](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#3-project-autonomy-is-the-structural-starting-point))
and a top-to-bottom mission commitment
([`MISSION.md` § Affordability and vendor neutrality](https://github.com/apache/magpie/blob/main/MISSION.md#affordability-and-vendor-neutrality--the-public-good-commitment)).
...
| **Project governance** | ASF PMC, foundation-hosted, single-vendor, informal maintainer group | Modes and thresholds are adopter config; non-ASF adopters are first-class ([`PRINCIPLES.md` §3](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#3-project-autonomy-is-the-structural-starting-point)) |
...
[label taxonomy](/docs/labels-and-capabilities); here they are read as the
...
a shortcut ([`PRINCIPLES.md` §12](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#12-the-framework-is-project-agnostic-concrete-names-live-in-adopter-config)).
...
[`tools/`](https://github.com/apache/magpie/tree/main/tools/). Two shapes:
...
|---|---|
| [`tools/cve-tool`](https://github.com/apache/magpie/tree/main/tools/cve-tool/) | CNA backends — Vulnogram, MITRE form, CVE.org direct, GHSA |
| [`tools/mail-archive`](https://github.com/apache/magpie/tree/main/tools/mail-archive/) | PonyMail, Hyperkitty, Discourse, Google Groups, GitHub Discussions |
| [`tools/mail-source`](https://github.com/apache/magpie/tree/main/tools/mail-source/) | mbox, IMAP, Gmail API ([`tools/gmail`](https://github.com/apache/magpie/tree/main/tools/gmail/)), Mailman 3 |
| [`tools/forwarder-relay`](https://github.com/apache/magpie/tree/main/tools/forwarder-relay/) | ASF Security relay, huntr.com, HackerOne triagers |
| [`tools/scan-format`](https://github.com/apache/magpie/tree/main/tools/scan-format/) | security-scanner report formats (ASVS reference) |
| [`tools/vcs`](https://github.com/apache/magpie/tree/main/tools/vcs/) | Git (complete), Mercurial (complete), Subversion, … (extension points) |

The security-team surface follows the same pattern: CNA backends live
behind [`tools/cve-tool`](https://github.com/apache/magpie/tree/main/tools/cve-tool/) (the ASF Vulnogram adapter
[`tools/cve-tool-vulnogram`](https://github.com/apache/magpie/tree/main/tools/cve-tool-vulnogram/) is the landed
reference), inbound report relays behind
[`tools/forwarder-relay`](https://github.com/apache/magpie/tree/main/tools/forwarder-relay/), scanner formats
behind [`tools/scan-format`](https://github.com/apache/magpie/tree/main/tools/scan-format/), and an OSV.dev
vulnerability cross-reference client [`tools/osv`](https://github.com/apache/magpie/tree/main/tools/osv/)
...
[capability taxonomy](/docs/labels-and-capabilities) is the canonical map
...
|---|---|---|
| [`tools/cve-tool`](https://github.com/apache/magpie/tree/main/tools/cve-tool/) | [`tools/cve-tool-vulnogram`](https://github.com/apache/magpie/tree/main/tools/cve-tool-vulnogram/) (ASF) | MITRE form, CVE.org direct, GHSA |
| [`tools/mail-archive`](https://github.com/apache/magpie/tree/main/tools/mail-archive/) | [`tools/ponymail`](https://github.com/apache/magpie/tree/main/tools/ponymail/) (ASF) | Hyperkitty, Discourse, Google Groups, GitHub Discussions |
| [`tools/mail-source`](https://github.com/apache/magpie/tree/main/tools/mail-source/) | mbox, IMAP, Gmail API ([`tools/gmail`](https://github.com/apache/magpie/tree/main/tools/gmail/)) | Mailman 3 |
| [`tools/forwarder-relay`](https://github.com/apache/magpie/tree/main/tools/forwarder-relay/) | ASF-security ([`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md)) | huntr.com, HackerOne |
| [`tools/scan-format`](https://github.com/apache/magpie/tree/main/tools/scan-format/) | ASVS | other scanner formats |
| [`tools/vcs`](https://github.com/apache/magpie/tree/main/tools/vcs/) | Git | Mercurial, Subversion, … |
...
([`organizations/<org>/`](https://github.com/apache/magpie/tree/main/organizations/)) groups those shared
...
[`organizations/ASF/`](https://github.com/apache/magpie/tree/main/organizations/ASF/);
[`organizations/independent/`](https://github.com/apache/magpie/tree/main/organizations/independent/) is the
...
[`organizations/README.md`](https://github.com/apache/magpie/blob/main/organizations/README.md).
...
- **Contribute it to Magpie.** Scaffold the adapter against the
  ...
  [`organizations/_template/`](https://github.com/apache/magpie/tree/main/organizations/_template/) for an
  organization) and open a PR. Accepted adapters ship under
  Apache-2.0 like the rest of the framework
  ([`PRINCIPLES.md` §17](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#17-contributions-land-under-apache-license-20)),
  so every other adopter on that backend reuses your work. The
  [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) flow and
  [`CONTRIBUTING.md`](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md) walk you through the conventions
  (a `**Capability:**` line, a `## Prerequisites` section, an eval); the
  step-by-step how-to is [`docs/adapters/authoring.md`](/docs/adapters/authoring).
- **Link to an adapter defined elsewhere.** You do not have to upstream
  ...
  [discovery index](/docs/adapters/registry) of in-tree and
  ...
  adopter-vouched; see [`docs/skill-sources/`](/docs/skill-sources/readme).)
...
organizations too — see [`docs/extending.md`](/docs/extending) for the full
...
([`docs/setup/privacy-llm.md`](/docs/setup/privacy-llm),
[RFC-AI-0003](/docs/rfcs/rfc-ai-0003)):
...
([`README.md` § snapshot + override](https://github.com/apache/magpie/blob/main/README.md)). Users already run
Magpie under several different agentic CLIs. Codex now has a
[first-class adapter](/docs/adapters/codex) (experimental); adding another
runtime is a [`family:tools`](/docs/labels-and-capabilities#1-family--subject)
contribution, not a re-architecture.
Gemini CLI also has an [experimental agent harness integration](/docs/adapters/gemini) that reads Magpie's canonical `.agents/skills/` tree.
Its guide covers setup, approval policies, verification, and [known limitations](/docs/adapters/gemini#known-limitations), including the remaining sandbox parity gaps.
...
[Cursor harness guide](/docs/adapters/cursor).
...
[Local LLM harness guide](/docs/adapters/local-llm).
...
[Goose harness guide](/docs/adapters/goose).
...
[Aider harness guide](/docs/adapters/aider).
...
[GitHub Copilot harness guide](/docs/adapters/copilot).
...
[`docs/adapters/add-a-harness.md`](/docs/adapters/add-a-harness).

### 3. Forge and tracker

Forge and tracker access is mediated entirely by the tool layer:
[`tools/github`](https://github.com/apache/magpie/tree/main/tools/github/) and [`tools/jira`](https://github.com/apache/magpie/tree/main/tools/jira/)
...
[`tools/github/tool.md` § When to replace this tool](https://github.com/apache/magpie/blob/main/tools/github/tool.md#when-to-replace-this-tool-with-another)
...
[`tools/bitbucket`](https://github.com/apache/magpie/tree/main/tools/bitbucket/) `partial-read-only` bridge;
...
existing [`tools/jira`](https://github.com/apache/magpie/tree/main/tools/jira/) bridge. The
...
- [`tools/mail-archive`](https://github.com/apache/magpie/tree/main/tools/mail-archive/) — public archive reads
  across PonyMail, Hyperkitty, Discourse, Google Groups, GitHub
  Discussions.
- [`tools/mail-source`](https://github.com/apache/magpie/tree/main/tools/mail-source/) — raw mail ingestion
...
- A **capability contract** — [`tools/github/source-control.md`](https://github.com/apache/magpie/blob/main/tools/github/source-control.md)
...
- A **backend-dispatching implementation** — [`tools/vcs`](https://github.com/apache/magpie/tree/main/tools/vcs/)
...
[`tools/asf-svn/`](https://github.com/apache/magpie/tree/main/tools/asf-svn/) adapter packages the SVN
...
([`PRINCIPLES.md` §3](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#3-project-autonomy-is-the-structural-starting-point)).
...
- **Eval is a release-blocking discipline**
  ([`PRINCIPLES.md` §8](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#8-eval-is-a-release-blocking-discipline)).
...
- Each skill lists the capabilities it needs; each capability has a
  ...
  the workflows.
- The [`write-skill`](https://github.com/apache/magpie/blob/main/skills/write-skill/SKILL.md) meta-skill and
  the contributor guidelines walk a newcomer through authoring a new
  tool or skill against the contracts.
- The built-in [eval harness](https://github.com/apache/magpie/tree/main/tools/skill-evals/) lets a contributor
...
| Agentic harness | ✅ by construction (`AGENTS.md` standard) | Claude Code; OpenCode; [Codex adapter](/docs/adapters/codex) (experimental); [Gemini adapter](/docs/adapters/gemini) (experimental); community use under Cursor, Copilot, Kiro | Remaining runtime adapters [#314–#322](https://github.com/apache/magpie/issues?q=is%3Aissue+state%3Aopen+adapter+in%3Atitle) |
...
| Source control (VCS) | ✅ by construction | **Git (complete)**, **Mercurial (complete)**; ASF SVN surface ([`tools/asf-svn`](https://github.com/apache/magpie/tree/main/tools/asf-svn/): source control + dist.apache.org + authorization) | Subversion generic VCS binding [\#602](https://github.com/apache/magpie/issues/602) (detected); Jujutsu [\#603](https://github.com/apache/magpie/issues/603), Fossil [\#604](https://github.com/apache/magpie/issues/604), Perforce [\#605](https://github.com/apache/magpie/issues/605) (tracked) |
...
metadata by
[`tools/vendor-neutrality-score`](https://github.com/apache/magpie/tree/main/tools/vendor-neutrality-score/), so
...
the [`privacy-llm` registry](https://github.com/apache/magpie/blob/main/tools/privacy-llm/models.md), which keys
...
**Overall vendor-neutrality score: 10/11 capability contracts (91%).** Generated by [`tools/vendor-neutrality-score`](https://github.com/apache/magpie/tree/main/tools/vendor-neutrality-score/); re-run it to refresh this section.
...
|---|---|
| capability-pure (names no backend) | 15 |
...
**Agent harness: 27/27 substrate tools run under any harness unchanged (100%).** Substrate tools are Magpie's own machinery; each declares the agent harness it integrates with (`**Harness:**`), or `agnostic`. A tool is neutral when it is harness-agnostic or supports two or more harnesses; *coupled* when it targets a single harness.
...
| `setup-preflight` | setup | any | ✅ agnostic |
...
| `skill-token-count` | framework-dev, analytics | any | ✅ agnostic |
...
| `vetted-ops` | sandbox | any | ✅ agnostic |
...
([`tools/maildir/`](https://github.com/apache/magpie/tree/main/tools/maildir/)) landed as the second, non-Google
...
([`tools/github/`](https://github.com/apache/magpie/tree/main/tools/github/)), patches on JIRA issues landed via
SVN ([`tools/jira-patch/`](https://github.com/apache/magpie/tree/main/tools/jira-patch/)), and `[PATCH]` threads
on `dev@` landed via SVN ([`tools/mail-patch/`](https://github.com/apache/magpie/tree/main/tools/mail-patch/)).
...
([`tools/change-request/`](https://github.com/apache/magpie/tree/main/tools/change-request/)), not the workflow.
...
- [`PRINCIPLES.md` §9 — Vendor neutrality is non-negotiable](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#9-vendor-neutrality-is-non-negotiable)
- [`PRINCIPLES.md` §3 — Project autonomy is the structural starting point](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#3-project-autonomy-is-the-structural-starting-point)
- [`MISSION.md` § Affordability and vendor neutrality](https://github.com/apache/magpie/blob/main/MISSION.md#affordability-and-vendor-neutrality--the-public-good-commitment)
- [`docs/labels-and-capabilities.md`](/docs/labels-and-capabilities) — the skill / tool / capability taxonomy this page reads as the neutrality mechanism
- [`docs/setup/privacy-llm.md`](/docs/setup/privacy-llm) — the six LLM-stack variants
- [`docs/rfcs/RFC-AI-0004.md` § Principle 3](/docs/rfcs/rfc-ai-0004#principle-3--vendor-neutrality) — vendor neutrality as a baseline ethics principle
- [`tools/vcs/`](https://github.com/apache/magpie/tree/main/tools/vcs/) and [`tools/github/source-control.md`](https://github.com/apache/magpie/blob/main/tools/github/source-control.md) — the VCS abstraction worked example
- [`docs/mode-economics.md`](/docs/mode-economics) — what each mode costs to run, per model class
