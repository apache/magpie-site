...
Gemini CLI also has an [experimental runtime adapter](/docs/adapters/gemini) that reads Magpie's canonical `.agents/skills/` tree. Its guide documents setup, supported controls, and remaining gaps from the reference configuration.
