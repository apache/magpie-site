...
Rendered page: https://magpie.apache.org/docs/skill-sources/registry/

Source: https://github.com/apache/magpie/blob/main/docs/skill-sources/registry.md
...
A **discovery** index of the external [skill sources](/docs/skill-sources/readme) Magpie
knows about — repositories other than `apache/magpie` that ship
Magpie-shaped skills. It is the skills counterpart to the
[adapter registry](/docs/adapters/registry).
...
> no install. Per [`PRINCIPLES.md` §14](https://github.com/apache/magpie/blob/main/PRINCIPLES.md#14-snapshot-plus-override-never-vendored-copies),
...
> [`README.md`](/docs/skill-sources/readme) for the trust model and the descriptor format.
...
|---|---|---|
| Apache Software Foundation | `apache-incubator`: [`apache/incubator`](https://github.com/apache/incubator) (`releasecheck`) | [`organizations/ASF/skill-sources.md`](https://github.com/apache/magpie/blob/main/organizations/ASF/skill-sources.md) |
| Independent (no formal governing body) | *(none listed yet)* | [`organizations/independent/skill-sources.md`](https://github.com/apache/magpie/blob/main/organizations/independent/skill-sources.md) |
...
- [`README.md`](/docs/skill-sources/readme) — the trust model, descriptor, and pointer-file formats.
- [`RFC-AI-0006`](/docs/rfcs/rfc-ai-0006) — design and threat model.
- [`docs/adapters/registry.md`](/docs/adapters/registry) — the sibling discovery index for tool adapters and organizations.
- [`docs/extending.md`](/docs/extending) — the full extension model.
