...
Rendered page: https://magpie.apache.org/docs/skill-sources/authoring-a-source/

Source: https://github.com/apache/magpie/blob/main/docs/skill-sources/authoring-a-source.md
...
source-repo counterpart of [`README.md`](/docs/skill-sources/readme), which describes the
...
descriptor](/docs/skill-sources/readme#source-descriptor) to their trust list, commit a
**pin** (method + URL + ref + a verification anchor), and run
`/magpie-setup skill-sources`
([`skills/setup/skill-sources.md`](https://github.com/apache/magpie/blob/main/skills/setup/skill-sources.md)),
...
[skill validator](https://github.com/apache/magpie/tree/main/tools/skill-and-tool-validator/) enforces them:
...
conventions in [`docs/extending.md`](/docs/extending) and
[`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md) — injection guards, the placeholder
...
[layout contract](/docs/skill-sources/readme#layout-contract--skills-evals-tests).
...
- **Register your org** — open a PR to `apache/magpie` adding
  ...
  [`organizations/_template/`](https://github.com/apache/magpie/blob/main/organizations/_template/organization.md)),
  ...
  the org layer. See [`organizations/README.md`](https://github.com/apache/magpie/blob/main/organizations/README.md).
...
[install recipes](/docs/quick-start/other-install-methods) verbatim, so these are the
...
Source descriptor](/docs/skill-sources/readme#source-descriptor).

## Step 7 — Get listed for discovery (optional, recommended)

Open a PR to `apache/magpie` adding:

- a row to [`registry.md`](/docs/skill-sources/registry) — the discovery index; and/or
...
installed](/docs/skill-sources/readme#how-a-trusted-skill-is-installed).
...
- [`README.md`](/docs/skill-sources/readme) — the feature from the adopter's side (formats, trust model, security model).
- [`registry.md`](/docs/skill-sources/registry) — the discovery index of known sources.
- [`RFC-AI-0006`](/docs/rfcs/rfc-ai-0006) — the design, trust, and threat model.
- [`skills/setup/skill-sources.md`](https://github.com/apache/magpie/blob/main/skills/setup/skill-sources.md) — the `/magpie-setup skill-sources` fetch/pin/symlink flow.
