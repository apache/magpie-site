...
→ Start with the [quick start](/docs/quick-start) — install into your agent in two commands. If a marketplace is not an option, the [install recipes](/docs/setup/install-recipes) cover the pinned snapshot install.

### Security team members

You handle CVE reports and want agent help with the 16-step lifecycle — import, triage, fix, allocate, publish.

→ Start with [security workflow overview](/docs/security/readme), then [new member onboarding](/docs/security/new-members-onboarding).
...
| Find or author a backend adapter | [adapters/registry.md](/docs/adapters/registry) |
