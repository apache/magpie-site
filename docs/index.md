...
Rendered page: https://magpie.apache.org/docs/index/

Source: https://github.com/apache/magpie/blob/main/docs/index.md
...
backend, tracker access: [prerequisites](/docs/quick-start/prerequisites). The
[quick start](/docs/quick-start) is two commands once those are in place.
...
|---|---|---|
| Setting up agents safely — sandbox, clean environment, privacy routing | [setup](/docs/setup/readme) | Any project |
| Security reports that need careful, audited handling | [security](/docs/security/readme) | Any project |
| A pull-request queue that's out of control | [pr-management](/docs/pr-management/readme) | Any project |
| Catching implementation-detail nits before you open a PR | [pairing](/docs/pairing/readme) | Any project |
| An issue backlog full of duplicates and stale reports | [issue-management](/docs/issue-management/readme) | Any project |
| Repo hygiene slipping — CI runners, dependencies, licenses, flaky tests | [repo-health](/docs/repo-health/readme) | Any project |
| Releases that are a manual, error-prone slog | [release-management](/docs/release-management/readme) | 🪶 ASF-specific |
| New contributors getting stuck and drifting away | [mentoring](/docs/mentoring/readme) | Any project |
| Growing contributors into committers | [contributor-growth](/docs/contributor-growth/readme) | 🪶 ASF-specific |
| Building or maintaining your own skills | [utilities](/docs/utilities/readme) | Any project |

Start with [`setup`](/docs/setup/readme) regardless — it is the prerequisite every adopter installs first — then add the families above as you need them.
...
→ Start with the [quick start](/docs/quick-start) — install into your agent in two commands — then [individual use](/docs/setup/individual-use). If a marketplace is not an option, [other installation methods](/docs/quick-start/other-install-methods) cover the pinned snapshot install.
...
→ [Team adoption](/docs/setup/team-adoption) — what a repo commits, how to decide it, and how to keep it current. Adoption is a recommendation to your contributors, not a requirement on them.

### Security team members

You handle CVE reports and want agent help with the 16-step lifecycle — import, triage, fix, allocate, publish.

→ Start with [security workflow overview](/docs/security/readme), then [how the security team works](/docs/security/how-the-security-team-works).

### Contributors to the Magpie framework itself

You want to improve the skills, add tools, or fix bugs in the framework.

→ Start with [CONTRIBUTING.md](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md) and the [spec-driven development](/docs/spec-driven-development) loop.

### People evaluating whether to adopt

You want to understand the trust model, cost, and governance commitments before deciding.

→ Read [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md) (the why), [PRINCIPLES.md](https://github.com/apache/magpie/blob/main/PRINCIPLES.md) (the rules), and [mode economics](/docs/mode-economics) (what it costs in tokens).
...
| I want to… | Read… |
|---|---|
| Understand the full vision | [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md) |
| Understand how it stays vendor-neutral | [vendor-neutrality.md](/docs/vendor-neutrality) |
| Find or author a backend adapter | [adapters/](/docs/adapters/readme) |
| Pull a skill/family from a trusted external source | [skill-sources/README.md](/docs/skill-sources/readme) |
| Extend Magpie (project / org / individual) | [extending.md](/docs/extending) |
| See what skills exist today | [modes.md](/docs/modes) |
| Install it right now | [quick-start.md](/docs/quick-start) |
| Check what a skill needs before it runs | [quick-start/prerequisites.md](/docs/quick-start/prerequisites) |
| Install in my project | [README → Install](https://github.com/apache/magpie/blob/main/README.md#install) |
| Set up the secure agent sandbox | [setup/](/docs/setup/readme) |
| Understand the security workflow | [security/](/docs/security/readme) |
| Know what it costs to run | [mode-economics.md](/docs/mode-economics) |
| Read the design behind a change in flight | [designs/](/docs/designs/readme) |
| Understand the privacy model | [rfcs/RFC-AI-0003.md](/docs/rfcs/rfc-ai-0003) |
| Read the RFCs behind the design | [rfcs/](/docs/rfcs/readme) |
| Contribute to the framework | [CONTRIBUTING.md](https://github.com/apache/magpie/blob/main/CONTRIBUTING.md) |
| Learn to build and extend skills | [education/](/docs/education/readme) |
