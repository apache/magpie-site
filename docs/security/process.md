...
Rendered page: https://magpie.apache.org/docs/security/process/

Source: https://github.com/apache/magpie/blob/main/docs/security/process.md
...
[role guides](/docs/security/roles) point into specific steps; the
[security skills](https://github.com/apache/magpie/tree/main/skills/) execute the steps; the
[threat model](/docs/security/threat-model) maps the steps and skills to trust
...
<!-- Placeholder convention (see AGENTS.md#placeholder-convention-used-in-skill-files):
     `<cve-tool>` → the adapter directory under `tools/` named by
                    ...
                    [`tools/cve-tool/`](https://github.com/apache/magpie/blob/main/tools/cve-tool/README.md);
...
[`<project-config>/canned-responses.md`](/docs/security/<project-config>/canned-responses)
...
|---|---|
| `VALID` | [`security-cve-allocate`](https://github.com/apache/magpie/blob/main/skills/security-cve-allocate/SKILL.md) → Step 6 |
| `DEFENSE-IN-DEPTH` | Close as wontfix + open a public PR for the hardening |
| `INFO-ONLY` | [`security-issue-invalidate`](https://github.com/apache/magpie/blob/main/skills/security-issue-invalidate/SKILL.md) with the matching canned-response template |
| `INVALID` | [`security-issue-invalidate`](https://github.com/apache/magpie/blob/main/skills/security-issue-invalidate/SKILL.md) |
| `PROBABLE-DUP` | [`security-issue-deduplicate`](https://github.com/apache/magpie/blob/main/skills/security-issue-deduplicate/SKILL.md) |
| `FIX-ALREADY-PUBLIC` | After reporter confirms the cited public PR fixes their report: [`security-issue-invalidate`](https://github.com/apache/magpie/blob/main/skills/security-issue-invalidate/SKILL.md). If the reporter says it does not fix it, re-triage with `--retriage`. No finder credit is recorded per the [no-credit-when-fix-is-already-public policy](https://github.com/apache/magpie/blob/main/skills/security-issue-import-from-pr/SKILL.md#reporter-credit-policy-for-public-pr-imports). |
...
proposal item — see [`security-issue-sync` Step 1c/2b](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/gather.md#1c-find-the-real-reporter-and-read-the-mailing-list-thread).
...
[`<project-config>/scope-labels.md`](/docs/security/<project-config>/scope-labels);
...
in [`<project-config>/project.md → CVE tooling`](/docs/security/<project-config>/project#cve-tooling)),
normalises the title per
[`<project-config>/title-normalization.md`](/docs/security/<project-config>/title-normalization),
...
[`<project-config>/milestones.md`](/docs/security/<project-config>/milestones)).
...
registry / equivalent),
[`security-issue-sync`](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/SKILL.md)
...
declared in [`<project-config>/project.md → cve_authority`](/docs/security/<project-config>/project#cve-authority).
...
2. **CVE record state is `review-ready`.** Sync pushes the
   ...
   [`<cve-tool>`](https://github.com/apache/magpie/blob/main/tools/cve-tool/README.md) adapter's
...
6. Promotes the record from `publish-ready` to `public` via the
   ...
   [`vulnogram-api-record-publish`](https://github.com/apache/magpie/blob/main/tools/cve-tool-vulnogram/oauth-api/README.md)
   under `poll`.
...
9. Archives the tracker from the `Announced` column via the
   ...
   [`tools/github/project-board.md` — *Archive a board item*](https://github.com/apache/magpie/blob/main/tools/github/project-board.md#archive-a-board-item--terminal-state-cleanup)).
...
[`<project-config>/scope-labels.md`](https://github.com/apache/magpie/tree/main/projects/) (for the currently
adopting project, [`<project-config>/scope-labels.md`](/docs/security/<project-config>/scope-labels)).
...
| `cve allocated` | A CVE has been reserved for the issue. Allocation itself is PMC-gated (only the adopting project's PMC members can submit the CVE-tool allocation form); a non-PMC triager relays a request to a PMC member via the [`security-cve-allocate`](https://github.com/apache/magpie/blob/main/skills/security-cve-allocate/SKILL.md) skill. | 6 | never |
...
The [`security-issue-sync`](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/SKILL.md)
