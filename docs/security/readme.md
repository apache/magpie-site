...
![Claude Code showing the magpie-security plugin installed and enabled](/docs-assets/quickstart/families/security-install.png)
...
- [**`new-members-onboarding.md`**](/docs/security/new-members-onboarding) —
...
- [`docs/prerequisites.md`](/docs/prerequisites) — what a security
