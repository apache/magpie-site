...
Rendered page: https://magpie.apache.org/docs/security/new-members-onboarding/

Source: https://github.com/apache/magpie/blob/main/docs/security/new-members-onboarding.md
...
[`<project-config>/`](https://github.com/apache/magpie/tree/main/docs/security/<project-config>/) (i.e. `.apache-magpie/` at
...
Read this end-to-end once, then use [`roles.md`](/docs/security/roles) as the
...
project, see
[`<project-config>/release-trains.md` — Security team roster](/docs/security/<project-config>/release-trains#security-team-roster)
...
- **Private PRs on the `<tracker>` `main` branch** — an exceptional
  ...
  [Step 9](/docs/security/process#step-9--open-a-private-pr-exceptional-cases) of
  the process.
...
1. **Read [`roles.md`](/docs/security/roles) once, skim the role sections.** Pick
...
4. **Read [`<project-config>/canned-responses.md`](/docs/security/<project-config>/canned-responses).** These are the
...
5. **Read [`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md) at least the
...
[Step 7](/docs/security/process#step-7--self-assign-and-implement-the-fix) for the
delegation rules).
...
[`.agents/skills/`](https://github.com/apache/magpie/tree/main/skills/). They are plain `SKILL.md`
...
- **`import new reports`** — converts un-imported security-list
  ...
  See [Step 2](/docs/security/process#step-2--import-the-report).
...
- **`allocate CVE for issue #N`** — when a report is assessed as valid.
  See [Step 6](/docs/security/process#step-6--allocate-the-cve).
...
- **`try to fix issue #N`** —
  ...
  [Step 9](/docs/security/process#step-9--open-a-private-pr-exceptional-cases). See
  [Steps 7–11 in the process reference](/docs/security/process#step-7--self-assign-and-implement-the-fix)
...
[`AGENTS.md` — Reusable skills](https://github.com/apache/magpie/blob/main/AGENTS.md#reusable-skills).
...
- [`README.md`](https://github.com/apache/magpie/blob/main/README.md) — the end-to-end handling process.
- [`<project-config>/canned-responses.md`](/docs/security/<project-config>/canned-responses) — reply templates.
- [`AGENTS.md`](https://github.com/apache/magpie/blob/main/AGENTS.md) — agent-facing conventions and confidentiality rules.
...
- [`<project-config>/`](https://github.com/apache/magpie/tree/main/docs/security/<project-config>/) — project-specific content
  ...
  tracker repo.
- [`how-to-fix-a-security-issue.md`](/docs/security/how-to-fix-a-security-issue) —
  high-level fix workflow.
- [`new-members-onboarding.md`](/docs/security/new-members-onboarding) — this
  document.
