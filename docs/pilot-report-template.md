...
Rendered page: https://magpie.apache.org/docs/pilot-report-template/

Source: https://github.com/apache/magpie/blob/main/docs/pilot-report-template.md
...
[`contributor-sentiment`](https://github.com/apache/magpie/blob/main/skills/contributor-sentiment/SKILL.md) skill
...
[`docs/contributor-sentiment.md`](/docs/contributor-sentiment) for the full
