...
Rendered page: https://magpie.apache.org/docs/setup/per-role-mcp-access/

Source: https://github.com/apache/magpie/blob/main/docs/setup/per-role-mcp-access.md
...
- Your `.apache-magpie-local/` directory exists (created by `/magpie-setup
  adopt`; see [`install-recipes.md`](/docs/quick-start/other-install-methods)) or create it:
  ...
  (see [`secure-agent-setup.md`](/docs/setup/secure-agent-setup) § User-scope
...
- [`agentic-overrides.md`](/docs/setup/agentic-overrides) — the full override
...
- [`setup-override-upstream`](https://github.com/apache/magpie/blob/main/skills/setup-override-upstream/SKILL.md)
  ...
  proves its value.
- [`install-recipes.md`](/docs/quick-start/other-install-methods) — bootstrap Magpie in a
