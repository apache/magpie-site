...
[Codex first-class runtime adapter](/docs/adapters/codex) for that
...
also ships
[`tools/agent-isolation/sandbox-status-line-rich.sh`](https://github.com/apache/magpie/blob/main/tools/agent-isolation/sandbox-status-line-rich.sh).
