...
Rendered page: https://magpie.apache.org/docs/setup/agentic-overrides/

Source: https://github.com/apache/magpie/blob/main/docs/setup/agentic-overrides.md
...
- **Configuration** — facts about the project a skill reads: the
  ...
  [`projects/_template/`](https://github.com/apache/magpie/blob/main/projects/_template/README.md), and
...
1. **`.apache-magpie-local/`** — personal, gitignored, never
   ...
   [`/magpie-setup config`](https://github.com/apache/magpie/blob/main/skills/setup/config.md). This is
...
2. **`.apache-magpie-overrides/`** — committed, project-wide.
   Written by [`/magpie-setup adopt`](https://github.com/apache/magpie/blob/main/skills/setup/adopt.md),
...
[`commit-attribution.md`](/docs/setup/commit-attribution#how-the-convention-is-resolved).
...
[`setup override`](https://github.com/apache/magpie/blob/main/skills/setup/overrides.md)
...
[`locks.md`](https://github.com/apache/magpie/blob/main/plugins/magpie-setup/skills/setup/locks.md#the-reconciled-block--what-was-checked-not-what-to-install)),
...
- [`setup` skill](https://github.com/apache/magpie/blob/main/skills/setup/SKILL.md) — the entry point
...
- [`overrides.md` sub-action](https://github.com/apache/magpie/blob/main/skills/setup/overrides.md) —
  interactive override creation (lets the user choose between the
  personal-local and committed surfaces).
- [Top-level README](https://github.com/apache/magpie/blob/main/README.md) — install flow.
- [`setup-status` skill](https://github.com/apache/magpie/blob/main/skills/setup-status/SKILL.md) —
