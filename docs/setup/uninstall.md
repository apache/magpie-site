...
Rendered page: https://magpie.apache.org/docs/setup/uninstall/

Source: https://github.com/apache/magpie/blob/main/docs/setup/uninstall.md
...
install recipe in [`install-recipes.md`](/docs/quick-start/other-install-methods)
...
> [`/magpie-setup upgrade`](https://github.com/apache/magpie/blob/main/skills/setup/upgrade.md)
...
[agent-target registry](https://github.com/apache/magpie/blob/main/skills/setup/agents.md):
...
itself is [`unadopt`](https://github.com/apache/magpie/blob/main/skills/setup/adopt.md#unadopt), a
...
[`.claude/skills/magpie-setup/uninstall.md`](https://github.com/apache/magpie/blob/main/skills/setup/uninstall.md).
...
[`install-recipes.md`](/docs/quick-start/other-install-methods) — the same path
a first-time adopter takes.

## See also

- [`docs/setup/README.md`](/docs/setup/readme) — the setup skill
  family overview (verify, upgrade, shared-config sync).
- [Top-level README — Install](https://github.com/apache/magpie/blob/main/README.md#install)
  — the original 3-step bootstrap.
- [`install-recipes.md`](/docs/quick-start/other-install-methods) — the
