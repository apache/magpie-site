...
install recipe in [`install-recipes.md`](/docs/setup/install-recipes)
...
[`install-recipes.md`](/docs/setup/install-recipes) — the same path
...
- [`install-recipes.md`](/docs/setup/install-recipes) — the
