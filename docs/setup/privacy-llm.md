...
Rendered page: https://magpie.apache.org/docs/setup/privacy-llm/

Source: https://github.com/apache/magpie/blob/main/docs/setup/privacy-llm.md
...
[`tools/privacy-llm/tool.md`](https://github.com/apache/magpie/blob/main/tools/privacy-llm/tool.md),
[`tools/privacy-llm/pii.md`](https://github.com/apache/magpie/blob/main/tools/privacy-llm/pii.md), and
...
2. Confirm authentication if the endpoint requires it. ASF
   ...
   (see [`AGENTS.md` — Local setup](https://github.com/apache/magpie/blob/main/AGENTS.md#local-setup)).
3. Place the file at `<project-config>/privacy-llm.md`. Commit.
