...
Rendered page: https://magpie.apache.org/docs/setup/mixed-adoption-teams/

Source: https://github.com/apache/magpie/blob/main/docs/setup/mixed-adoption-teams.md
...
[`agents.md`](https://github.com/apache/magpie/blob/main/skills/setup/agents.md)) — not through a relay dir
...
[`agentic-overrides.md`](/docs/setup/agentic-overrides) for the full override
syntax.
...
1. Run `/magpie-setup install` in the shared repo (see
   [`install-recipes.md`](/docs/setup/install-recipes)) — this commits the bootstrap
...
- [Agentic overrides](/docs/setup/agentic-overrides) — full contract for what you
  can put in `.apache-magpie-local/` and `.apache-magpie-overrides/`,
  including enabling role-specific MCP servers just for yourself.
- [Full install recipe](/docs/setup/install-recipes) — if the team later decides
  to adopt Magpie, this is the canonical install walkthrough.
- [Secure agent setup](/docs/setup/secure-agent-setup) — the full install reference
  including the user-scope sandbox.
- [Setup skill family](/docs/setup/readme) — overview of all setup skills and deep
  documentation pages.
