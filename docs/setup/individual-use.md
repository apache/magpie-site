...
or to
[report it](https://github.com/apache/magpie/blob/main/skills/report-framework-issue/SKILL.md) so the skill is
...
- [`setup-status` skill](https://github.com/apache/magpie/blob/main/skills/setup-status/SKILL.md) — reports what is
