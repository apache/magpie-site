...
See [`docs/modes.md` § Agentic Autonomous](/docs/modes#agentic-autonomous).
...
- [`docs/prerequisites.md`](/docs/prerequisites) — what you need to run the framework, including model-backend setup.
