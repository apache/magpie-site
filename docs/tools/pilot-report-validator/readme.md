...
Rendered page: https://magpie.apache.org/docs/tools/pilot-report-validator/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/pilot-report-validator/readme.md
...
in [`docs/pilot-report-template.md`](https://github.com/apache/magpie/blob/main/docs/pilot-report-template.md).
