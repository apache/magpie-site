...
Widening the surface means editing [`ops.py`](https://github.com/apache/magpie/blob/main/tools/vetted-ops/src/vetted_ops/ops.py) — a reviewed code change, not a runtime decision.
