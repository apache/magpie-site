...
Rendered page: https://magpie.apache.org/docs/tools/asf-svn/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/asf-svn/readme.md
...
[`tools/github/`](https://github.com/apache/magpie/tree/main/tools/github/). Where the GitHub tool covers forge
...
- **SVN source control** ([`source-control.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/source-control.md)) —
...
- **SVN operations** ([`operations.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/operations.md)) — `svn` CLI
  recipes and the canonical `svn.apache.org/repos/asf/<project>`
  layout (trunk / branches / tags).
- **Release distribution** ([`release-distribution.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/release-distribution.md)) —
...
- **Authorization / roster** ([`authorization.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/authorization.md)) —
  resolve committer and PMC membership from the ASF authorization
  model (`asf-authorization-template`, LDAP groups) via the
  [`apache-projects`](https://github.com/apache/magpie/tree/main/tools/apache-projects/) MCP, so skills know who may
  commit or cut a release.
- **Website / docs publishing** (optional)
  ([`publishing.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/publishing.md)) — for projects that publish their
  site through SVN (svnpubsub / staging), a publish helper that reduces
  to a confirmed `svn commit` to the site path.
- **Tool overview** ([`tool.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/tool.md)) — the full capability table
...
- **Credentials / auth:** A cached SVN credential with write access to
  ...
  pre-flight in [`operations.md#authentication`](https://github.com/apache/magpie/blob/main/tools/asf-svn/operations.md#authentication).
...
- **Optional:** `apache-projects` MCP ([`tools/apache-projects/`](https://github.com/apache/magpie/tree/main/tools/apache-projects/))
  for roster lookups against `projects.apache.org` — used by
  [`authorization.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/authorization.md) when LDAP is not directly
...
[`tool.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/tool.md#when-to-use-this-tool-alongside-another) for the
combination rules):
