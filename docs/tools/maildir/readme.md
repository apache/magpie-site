...
Rendered page: https://magpie.apache.org/docs/tools/maildir/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/maildir/readme.md
...
It is the local counterpart of [`tools/gmail/`](https://github.com/apache/magpie/tree/main/tools/gmail/): where Gmail
...
- **`contract:mail-source`** — read an inbound `<security-list>` archive
  ...
  [`tools/mail-source/mbox/README.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/mbox/README.md); the
...
[`docs/vendor-neutrality.md`](https://github.com/apache/magpie/blob/main/docs/vendor-neutrality.md).
...
[`tools/mail-source/contract.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/contract.md). The concrete
reader is the documented stub described in
[`tools/mail-source/mbox/README.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/mbox/README.md); this
...
[`tools/mail-source/mbox/README.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/mbox/README.md)
(archive path + read-only enforcement).

## Cross-references

- Outbound contract: `contract:mail-create` (also implemented by
  [`tools/gmail/`](https://github.com/apache/magpie/tree/main/tools/gmail/)).
- Inbound contract: [`tools/mail-source/contract.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/contract.md);
  local-archive adapter [`tools/mail-source/mbox/README.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/mbox/README.md).
- Vendor-neutrality rationale: [`docs/vendor-neutrality.md`](https://github.com/apache/magpie/blob/main/docs/vendor-neutrality.md).
- Sibling outbound backend: [`tools/gmail/draft-backends.md`](https://github.com/apache/magpie/blob/main/tools/gmail/draft-backends.md).
