...
Rendered page: https://magpie.apache.org/docs/tools/egress-gateway/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/egress-gateway/readme.md
...
[RFC-AI-0003](https://github.com/apache/magpie/blob/main/docs/rfcs/RFC-AI-0003.md): even if a skill or a
prompt-injection tries to send private data to an arbitrary endpoint, the
destination is blocked.

The contract (what/why) lives in [`tool.md`](https://github.com/apache/magpie/blob/main/tools/egress-gateway/tool.md); this file is the
how-to.
...
(see [`docs/setup/sandbox-troubleshooting.md`](https://github.com/apache/magpie/blob/main/docs/setup/sandbox-troubleshooting.md)
