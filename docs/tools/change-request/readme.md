...
Rendered page: https://magpie.apache.org/docs/tools/change-request/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/change-request/readme.md
...
|---|---|---|---|---|
| GitHub pull request | [`tools/github/`](https://github.com/apache/magpie/tree/main/tools/github/) | GitHub | Shipping | `gh pr merge` (forge lands + closes) |
| JIRA patch | [`tools/jira-patch/`](https://github.com/apache/magpie/tree/main/tools/jira-patch/) | Atlassian | Shipping | delegates to `contract:source-control` (`svn patch` + `svn commit`) |
| `dev@` `[PATCH]` thread | [`tools/mail-patch/`](https://github.com/apache/magpie/tree/main/tools/mail-patch/) | email | Shipping | delegates to `contract:source-control` (`svn patch` + `svn commit`) |
...
| Skill | Verbs used |
|---|---|
| [`pr-management-triage`](https://github.com/apache/magpie/blob/main/skills/pr-management-triage/SKILL.md) | `list_open`, `get`, `get_discussion`, `status`, `post_review` (comment), `reject` (close). **Never** `land` — triage does not merge. |
| [`pr-management-code-review`](https://github.com/apache/magpie/blob/main/skills/pr-management-code-review/SKILL.md) | `get`, `get_discussion`, `post_review` (approve / request-changes). |
| [`pr-management-quick-merge`](https://github.com/apache/magpie/blob/main/skills/pr-management-quick-merge/SKILL.md) | `list_open`, `get`, `status`, `post_review` (approve), `land` (on per-PR confirmation). |
| [`pr-management-mentor`](https://github.com/apache/magpie/blob/main/skills/pr-management-mentor/SKILL.md) | `get`, `get_discussion`, `post_review` (comment). |
| [`pr-management-stats`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/SKILL.md) | `list_open` (read-only queue metrics). |
