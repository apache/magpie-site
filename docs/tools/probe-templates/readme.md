...
Rendered page: https://magpie.apache.org/docs/tools/probe-templates/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/probe-templates/readme.md
...
[`issue-reproducer`](https://github.com/apache/magpie/blob/main/skills/issue-reproducer/SKILL.md)
...
skill's [`probe-templates.md`](https://github.com/apache/magpie/blob/main/skills/issue-reproducer/probe-templates.md)
...
- [`issue-reproducer/probe-templates.md`](https://github.com/apache/magpie/blob/main/skills/issue-reproducer/probe-templates.md) —
  the skill-side procedural detail.
- [`issue-reproducer/verdict-composition.md`](https://github.com/apache/magpie/blob/main/skills/issue-reproducer/verdict-composition.md) —
  schema for the `cross_type_probe` and `operator_variants_probe`
  sub-objects.
- [`<project-config>/reproducer-conventions.md`](https://github.com/apache/magpie/blob/main/projects/_template/reproducer-conventions.md) —
