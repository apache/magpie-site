...
Rendered page: https://magpie.apache.org/docs/tools/vendor-neutrality-score/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/vendor-neutrality-score/readme.md
...
1. **`tools/*/README.md`** — each contract tool declares `**Capability:**`
   ...
   ([coverage qualifiers](https://github.com/apache/magpie/blob/main/docs/labels-and-capabilities.md#coverage-qualifiers))
