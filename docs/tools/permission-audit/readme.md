...
Rendered page: https://magpie.apache.org/docs/tools/permission-audit/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/permission-audit/readme.md
...
[`/magpie-setup verify`](https://github.com/apache/magpie/blob/main/skills/setup/verify.md#8d-permission-allow-list-hygiene)
...
See [`src/permission_audit/audit.py`](https://github.com/apache/magpie/blob/main/tools/permission-audit/src/permission_audit/audit.py).
