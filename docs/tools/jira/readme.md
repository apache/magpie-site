...
from [`<project-config>/issue-tracker-config.md`](https://github.com/apache/magpie/blob/main/projects/_template/issue-tracker-config.md)
...
- [`issue-triage`](https://github.com/apache/magpie/blob/main/skills/issue-triage/SKILL.md) —
  primary consumer (selector resolution + per-issue fetch).
- [`issue-reassess`](https://github.com/apache/magpie/blob/main/skills/issue-reassess/SKILL.md) —
...
- [`<project-config>/issue-tracker-config.md`](https://github.com/apache/magpie/blob/main/projects/_template/issue-tracker-config.md) —
