...
Rendered page: https://magpie.apache.org/docs/tools/ponymail/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/ponymail/readme.md
...
PonyMail archive substrate. Read-only ASF mailing-list archive client; complements `gmail` for threads not present in the inbox. Used by security-issue-import + sync to cross-reference public mailing-list discussions. See [`tool.md`](https://github.com/apache/magpie/blob/main/tools/ponymail/tool.md) for the operation catalogue and [`operations.md`](https://github.com/apache/magpie/blob/main/tools/ponymail/operations.md) for usage.
