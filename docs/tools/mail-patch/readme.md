...
Rendered page: https://magpie.apache.org/docs/tools/mail-patch/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/mail-patch/readme.md
...
[`tools/change-request/`](https://github.com/apache/magpie/tree/main/tools/change-request/) contract for the oldest
...
- **Reads** flow through [`contract:mail-archive`](https://github.com/apache/magpie/tree/main/tools/mail-archive/)
  (`tools/ponymail/` at the ASF) — thread search, thread fetch,
  participant extraction.
- **Review replies** are drafted through
  [`contract:mail-create`](https://github.com/apache/magpie/tree/main/tools/gmail/) — the adapter never sends mail
...
project's [`contract:source-control`](https://github.com/apache/magpie/tree/main/tools/asf-svn/) adapter
...
| `land(id, strategy)` | **Delegates to `contract:source-control`.** Extracts the patch via `get`, calls the source-control adapter's apply + commit (`svn patch <file>` then `svn commit` — see [`tools/asf-svn/source-control.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/source-control.md)), then drafts an "applied in rNNNNN, thanks!" reply on the thread. `strategy` is advisory — SVN lands a patch as one commit (`squash`). |
...
- Contract: [`tools/change-request/`](https://github.com/apache/magpie/tree/main/tools/change-request/)
- Archive reads: [`tools/mail-archive/`](https://github.com/apache/magpie/tree/main/tools/mail-archive/) (ASF: [`tools/ponymail/`](https://github.com/apache/magpie/tree/main/tools/ponymail/))
- Reply drafting: [`contract:mail-create`](https://github.com/apache/magpie/tree/main/tools/gmail/)
- Delegated land: [`tools/asf-svn/source-control.md`](https://github.com/apache/magpie/blob/main/tools/asf-svn/source-control.md)
