...
Rendered page: https://magpie.apache.org/docs/tools/pr-management-stats/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/pr-management-stats/readme.md
...
[`pr-management-stats`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/SKILL.md) skill.
...
2. **CI-renderable artefact.** Adopters who want a daily dashboard
   ...
   [`render.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/render.md),
...
[`dashboard.py`](https://github.com/apache/magpie/blob/main/tools/pr-management-stats/dashboard.py); it imports the fetch + classify
...
4. Classifies each PR per
   [`classify.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/classify.md) —
...
- Use the GraphQL templates from [`fetch.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/fetch.md) verbatim. **In particular, the open-PRs query MUST include `reviewThreads` and `latestReviews` and `timelineItems`** — without those, the `is_engaged` predicate is undercounted and untriaged numbers blow up artificially. (Earlier iterations of `fetch.md` claimed those fields were not needed for stats; that was a documentation bug and has been corrected.)
- Implement ALL 11 sections per [`render.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/render.md). Skipping panels (e.g. dropping the line charts, CODEOWNERS table, triager-activity table) is **not** an acceptable simplification.
...
- [`pr-management-stats/SKILL.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/SKILL.md) — skill entry point.
- [`pr-management-stats/classify.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/classify.md) — `is_engaged` / `is_triaged` / `is_untriaged` predicates.
- [`pr-management-stats/fetch.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/fetch.md) — GraphQL templates.
- [`pr-management-stats/aggregate.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/aggregate.md) — per-panel computations.
- [`pr-management-stats/render.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-stats/render.md) — dashboard layout, recommendation rules.
- [`tools/dashboard-generator/`](https://github.com/apache/magpie/tree/main/tools/dashboard-generator/) — sibling reference implementation for `issue-reassess-stats`.
