...
Rendered page: https://magpie.apache.org/docs/tools/dashboard-generator/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/dashboard-generator/readme.md
...
[`issue-reassess-stats`](https://github.com/apache/magpie/blob/main/skills/issue-reassess-stats/SKILL.md)
...
[`issue-reassess-stats/aggregate.md`](https://github.com/apache/magpie/blob/main/skills/issue-reassess-stats/aggregate.md),
and emits the HTML per
[`issue-reassess-stats/render.md`](https://github.com/apache/magpie/blob/main/skills/issue-reassess-stats/render.md).
