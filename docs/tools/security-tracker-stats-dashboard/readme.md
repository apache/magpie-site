...
Rendered page: https://magpie.apache.org/docs/tools/security-tracker-stats-dashboard/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/security-tracker-stats-dashboard/readme.md
...
[`.claude/skills/security-tracker-stats-dashboard/SKILL.md`](https://github.com/apache/magpie/blob/main/skills/security-tracker-stats-dashboard/SKILL.md)
...
See [`default-config.yaml`](https://github.com/apache/magpie/blob/main/tools/security-tracker-stats-dashboard/default-config.yaml) for the full schema
