...
Rendered page: https://magpie.apache.org/docs/tools/sandbox-lint/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/sandbox-lint/readme.md
...
These are static checks of project files; user/admin policies, saved grants, workspace trust, and live enforcement require [runtime verification](https://github.com/apache/magpie/blob/main/docs/adapters/gemini.md#verify).
...
Optional [runtime integration tests](https://github.com/apache/magpie/blob/main/tools/sandbox-lint/tests/integration/README.md) exercise Gemini's policy engine and Linux sandbox without a model.
...
2. **Hard invariants.** Independent of the baseline, the live
   ...
   - `permissions.deny` contains the verbatim entries listed in
     [`src/sandbox_lint/__init__.py`](https://github.com/apache/magpie/blob/main/tools/sandbox-lint/src/sandbox_lint/__init__.py)
...
- The
  [`sandbox-lint`](https://github.com/apache/magpie/blob/main/.github/workflows/sandbox-lint.yml)
...
- The repository's `prek` config
  ([`.pre-commit-config.yaml`](https://github.com/apache/magpie/blob/main/.pre-commit-config.yaml)) runs
