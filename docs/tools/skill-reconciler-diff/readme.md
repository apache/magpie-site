...
Rendered page: https://magpie.apache.org/docs/tools/skill-reconciler-diff/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/skill-reconciler-diff/readme.md
...
grounds the [`skill-reconciler`](https://github.com/apache/magpie/blob/main/skills/skill-reconciler/SKILL.md)
...
[`skills/skill-reconciler/safety-baseline-checklist.md`](https://github.com/apache/magpie/blob/main/skills/skill-reconciler/safety-baseline-checklist.md):
...
[`skill-reconciler`](https://github.com/apache/magpie/blob/main/skills/skill-reconciler/SKILL.md) skill (the skill
