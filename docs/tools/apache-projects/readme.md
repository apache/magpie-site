...
Rendered page: https://magpie.apache.org/docs/tools/apache-projects/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/apache-projects/readme.md
...
`main` of `apache/comdev`. See [`tool.md`](https://github.com/apache/magpie/blob/main/tools/apache-projects/tool.md) for the
