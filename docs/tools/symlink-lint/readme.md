...
Rendered page: https://magpie.apache.org/docs/tools/symlink-lint/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/symlink-lint/readme.md
...
[`skills/setup/agents.md`](https://github.com/apache/magpie/blob/main/skills/setup/agents.md)): the canonical
...
Behaviour is locked by the pytest suite under [`tests/`](https://github.com/apache/magpie/tree/main/tools/symlink-lint/tests/), run by the
