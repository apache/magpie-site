...
Rendered page: https://magpie.apache.org/docs/tools/skill-evals/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/skill-evals/readme.md
...
- **security-issue-sync**: 45 cases across 9 steps (1f, 2a, 2b, 2c, 3, 6, bulk-orchestration, guardrails, security-cc)
- **security-issue-fix** — 33 cases across 11 steps (2, 4a, 4b, 4c, 4d, 4e, 4f, 4g, 5, 10)
...
- **setup-upstream-fix** — 8 cases across 2 suites (step-2-classify, step-3-dedup)
...
setup](https://github.com/apache/magpie/blob/main/docs/setup/secure-agent-setup.md) does not have them, so
an agent that types one of those command lines gets one `ERROR` per
case. [`magpie-run-evals.sh`](https://github.com/apache/magpie/blob/main/tools/skill-evals/magpie-run-evals.sh) is the one shape it
can run itself:
