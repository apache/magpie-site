...
- **release-promote** — 8 cases across 2 suites (step-0-preflight, step-2-emit-commands)
- **release-rc-cut** — 9 cases across 3 suites (step-0-preflight, step-2-tag-build-sign, step-3-staging)
- **release-verify-rc** — 13 cases across 6 suites (step-0-preflight, step-2-verify-signatures, step-3-verify-checksums, step-5-notice-license, step-6-binary-exclusion, step-8-version-consistency)
