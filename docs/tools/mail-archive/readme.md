...
Rendered page: https://magpie.apache.org/docs/tools/mail-archive/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/mail-archive/readme.md
...
[`tools/gmail/ponymail-archive.md`](https://github.com/apache/magpie/blob/main/tools/gmail/ponymail-archive.md) and
in [`tools/ponymail/operations.md`](https://github.com/apache/magpie/blob/main/tools/ponymail/operations.md). PR1
...
|---|---|---|---|
| `ponymail` | shipping | [`tools/ponymail/`](https://github.com/apache/magpie/tree/main/tools/ponymail/) (will be renamed to `tools/mail-archive-ponymail/` in PR3) | ASF's `lists.apache.org` deployment; PMC LDAP OAuth for private lists; anonymous read for public lists; load-bearing for the `security-issue-import`, `security-issue-sync`, and `security-issue-invalidate` skills today. |
...
[`tools/ponymail/`](https://github.com/apache/magpie/tree/main/tools/ponymail/). This is the only mail-archive
...
[`tools/ponymail/`](https://github.com/apache/magpie/tree/main/tools/ponymail/) (read-side via the
[`apache/comdev` `mcp/ponymail-mcp/`](https://github.com/apache/comdev/tree/main/mcp/ponymail-mcp)
MCP server) and [`tools/gmail/ponymail-archive.md`](https://github.com/apache/magpie/blob/main/tools/gmail/ponymail-archive.md)
...
in [`tools/ponymail/tool.md`](https://github.com/apache/magpie/blob/main/tools/ponymail/tool.md#setup) and is run
