...
Rendered page: https://magpie.apache.org/docs/tools/preflight-audit/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/preflight-audit/readme.md
...
([`bulk-mode.md` § Pre-flight no-op classifier](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/SKILL.md))
...
The classifier in
[`src/preflight_audit/classifier.py`](https://github.com/apache/magpie/blob/main/tools/preflight-audit/src/preflight_audit/classifier.py)
is the executable spec of the rule table in
[`.claude/skills/security-issue-sync/bulk-mode.md`](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/bulk-mode.md).
...
The tests in
[`tests/test_classifier.py`](https://github.com/apache/magpie/blob/main/tools/preflight-audit/tests/test_classifier.py) cover
