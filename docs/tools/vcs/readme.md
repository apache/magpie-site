...
Rendered page: https://magpie.apache.org/docs/tools/vcs/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/vcs/readme.md
...
documented in
[`tools/github/source-control.md`](https://github.com/apache/magpie/blob/main/tools/github/source-control.md). It
...
| `fossil` | **complete** | Fossil SCM; pairs with the [`tools/fossil`](https://github.com/apache/magpie/tree/main/tools/fossil/) forge bridge |
