...
Rendered page: https://magpie.apache.org/docs/tools/spec-loop/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/spec-loop/readme.md
...
[`docs/spec-driven-development.md`](https://github.com/apache/magpie/blob/main/docs/spec-driven-development.md);
...
See the [Gemini runner notes](https://github.com/apache/magpie/blob/main/docs/adapters/gemini.md#spec-loop-runner) for supported use and upgrade impact.
...
See the SECURITY notes in [`loop.sh`](https://github.com/apache/magpie/blob/main/tools/spec-loop/loop.sh).
...
| File | Role |
|---|---|
| [`specs/`](https://github.com/apache/magpie/tree/main/tools/spec-loop/specs/) | The functional description of the product — one spec per area. The desired state the loop reconciles code against. |
| [`IMPLEMENTATION_PLAN.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/IMPLEMENTATION_PLAN.md) | Prioritised **work items** (the gaps). One work item = one branch = one PR. |
| [`AGENTS.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/AGENTS.md) | Loop-scoped operational rules (repo map, validation commands, branch + hard-limit rules). |
...
[`docs/spec-driven-development.md` § Security and unattended agent loops](https://github.com/apache/magpie/blob/main/docs/spec-driven-development.md#security-and-unattended-agent-loops).
...
- `SPEC_LOOP_EFFORT` — reasoning-effort band: `low`, `medium`, or `high`.
  ...
  effort table in
  [`specs/spec-loop-runner.md`](https://github.com/apache/magpie/blob/main/tools/spec-loop/specs/spec-loop-runner.md).
...
[`docs/rfcs/`](https://github.com/apache/magpie/tree/main/docs/rfcs/) are the separate normative governance
