...
Rendered page: https://magpie.apache.org/docs/tools/forwarder-relay/readme/

Source: https://github.com/apache/magpie/blob/main/docs/tools/forwarder-relay/readme.md
...
[`<project-config>/project.md`](https://github.com/apache/magpie/blob/main/projects/_template/project.md).
...
- **Network:** None directly — the contract performs no I/O. Mail
  fetch/draft happens in the [`tools/mail-source`](https://github.com/apache/magpie/blob/main/tools/mail-source/contract.md) layer.
...
1. **Credit extraction.** The `From:` header of a relay message
   ...
   policy in
   [`tools/cve-tool-vulnogram/bot-credits-policy.md`](https://github.com/apache/magpie/blob/main/tools/cve-tool-vulnogram/bot-credits-policy.md)
...
2. **Reply routing.** Drafts intended for the reporter must go
   ...
   See [`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) for
...
3. **Question batching.** The project should not pester the
   ...
   [`docs/security/forwarder-routing-policy.md`](https://github.com/apache/magpie/blob/main/docs/security/forwarder-routing-policy.md)
...
|---|---|---|---|
| `asf-security` | shipping | Mail from `security@apache.org` or a personal `@apache.org` address with the ASF forwarding preamble | [`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) |
...
declared org-level in [`organizations/ASF/organization.md`](https://github.com/apache/magpie/blob/main/organizations/ASF/organization.md)
and inherited through project.md `forwarders.asf-security.contact_handle`),
and `reporter_addressing_block` convention
all live in [`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md).
...
(per [`organizations/ASF/organization.md`](https://github.com/apache/magpie/blob/main/organizations/ASF/organization.md));
...
* `security-issue-import` can print the matched preamble in its
  ...
  affordance;
* the test harness in
  [`tools/skill-and-tool-validator/`](https://github.com/apache/magpie/tree/main/tools/skill-and-tool-validator/)
...
[`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) — the
...
|---|---|---|
| [`security-issue-import`](https://github.com/apache/magpie/blob/main/skills/security-issue-import/SKILL.md) | Step 3 — classification | `detect()` on every enabled adapter; the first non-null return classifies the candidate as a relay import |
...
| [`security-issue-sync`](https://github.com/apache/magpie/blob/main/skills/security-issue-sync/SKILL.md) | Step 2b — draft routing | `contact_handle` + `reporter_addressing_block()` for any reporter-facing draft (CVE-allocated, fix-merged, advisory-shipped) on a relay tracker |
| [`security-issue-invalidate`](https://github.com/apache/magpie/blob/main/skills/security-issue-invalidate/SKILL.md) | Step 5d — ASF-relay branch | `reporter_addressing_block()` for the polite-but-firm invalidation notice routed through the forwarder |
| [`security-cve-allocate`](https://github.com/apache/magpie/blob/main/skills/security-cve-allocate/SKILL.md) | Step 4 — dual-mode draft | `via_forwarder_question_mode` to decide whether the CVE-allocation draft folds in the credit-preference ask or sends it separately |
| [`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) | reference doc for the shipping adapter | this whole file is the formal contract that `asf-relay.md` documents prose-style |
...
[`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) under the
...
declared once in [`organizations/ASF/organization.md`](https://github.com/apache/magpie/blob/main/organizations/ASF/organization.md).
...
* **Drafting convention** —
  [`tools/gmail/asf-relay.md`](https://github.com/apache/magpie/blob/main/tools/gmail/asf-relay.md) carries
...
* **Mail-source layer** — this contract sits on top of the
  ...
  [`tools/mail-source/contract.md`](https://github.com/apache/magpie/blob/main/tools/mail-source/contract.md);
...
* **Multi-thread reconciliation.** When a tracker records both
  ...
  [`tools/gmail/threading.md`](https://github.com/apache/magpie/blob/main/tools/gmail/threading.md) —
