...
Rendered page: https://magpie.apache.org/docs/release-management/svn-release-runbook/

Source: https://github.com/apache/magpie/blob/main/docs/release-management/svn-release-runbook.md
...
> to publish — see the
> [ATR release runbook](/docs/release-management/atr-release-runbook). Same 14-step
> lifecycle, same skills, different distribution backend.

This runbook is the hands-on companion to the
[`release-rc-cut`](https://github.com/apache/magpie/blob/main/skills/release-rc-cut/SKILL.md) skill
(lifecycle Steps 4–5). The skill *emits* this command set tailored
to the adopter's [`release-build.md`](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md);
...
([spec § Boundary 1 / Boundary 2](/docs/release-management/spec)).
...
[14-step process](/docs/release-management/process):

| Step | Owner skill | This runbook |
|---|---|---|
| 1–2 Plan + version bump | [`release-prepare`](https://github.com/apache/magpie/blob/main/skills/release-prepare/SKILL.md) | prerequisite |
| 3 `KEYS` reconciliation | [`release-keys-sync`](https://github.com/apache/magpie/blob/main/skills/release-keys-sync/SKILL.md) | prerequisite |
| **4 Cut RC: tag + build + sign** | [`release-rc-cut`](https://github.com/apache/magpie/blob/main/skills/release-rc-cut/SKILL.md) | **Steps 2–6 below** |
| **5 Stage to `dist/dev/`** | [`release-rc-cut`](https://github.com/apache/magpie/blob/main/skills/release-rc-cut/SKILL.md) | **Step 7 below** |
| 6 Pre-flight verify | [`release-verify-rc`](https://github.com/apache/magpie/blob/main/skills/release-verify-rc/SKILL.md) | downstream |
| 7–9 Vote + tally | [`release-vote-draft`](https://github.com/apache/magpie/blob/main/skills/release-vote-draft/SKILL.md), [`release-vote-tally`](https://github.com/apache/magpie/blob/main/skills/release-vote-tally/SKILL.md) | downstream |
| 10 Promote `dist/dev/ → dist/release/` | [`release-promote`](https://github.com/apache/magpie/blob/main/skills/release-promote/SKILL.md) | downstream |
...
> [`release-promote`](https://github.com/apache/magpie/blob/main/skills/release-promote/SKILL.md). Never
...
- **The prep PR is merged** — version strings, `CHANGELOG`,
  ...
  ([`release-prepare prep`](https://github.com/apache/magpie/blob/main/skills/release-prepare/SKILL.md),
  Step 2).
...
(If the [`release-rc-cut`](https://github.com/apache/magpie/blob/main/skills/release-rc-cut/SKILL.md)
...
> [`release-verify-rc`](https://github.com/apache/magpie/blob/main/skills/release-verify-rc/SKILL.md) in
...
> PMC-gated step ([`release-promote`](https://github.com/apache/magpie/blob/main/skills/release-promote/SKILL.md)).
...
1. **Verify** the staged RC end-to-end — signatures against the
   ...
   [`release-verify-rc`](https://github.com/apache/magpie/blob/main/skills/release-verify-rc/SKILL.md)
   (Step 6).
...
4. **Promote** `dist/dev/ → dist/release/` once the vote passes —
   ...
   [`release-promote`](https://github.com/apache/magpie/blob/main/skills/release-promote/SKILL.md)
   (Step 10).
...
- [`release-rc-cut`](https://github.com/apache/magpie/blob/main/skills/release-rc-cut/SKILL.md) — the
  skill that emits this command set from
  [`release-build.md`](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md).
- [`release-keys-sync`](https://github.com/apache/magpie/blob/main/skills/release-keys-sync/SKILL.md),
  [`release-verify-rc`](https://github.com/apache/magpie/blob/main/skills/release-verify-rc/SKILL.md),
  [`release-promote`](https://github.com/apache/magpie/blob/main/skills/release-promote/SKILL.md) — the
