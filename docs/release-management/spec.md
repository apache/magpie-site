...
Rendered page: https://magpie.apache.org/docs/release-management/spec/

Source: https://github.com/apache/magpie/blob/main/docs/release-management/spec.md
...
defines the harness contract those skills satisfy. The lifecycle they
execute against is in [`process.md`](/docs/release-management/process); the family overview is
in [`README.md`](/docs/release-management/readme). The pattern matches
[Mentoring](/docs/mentoring/spec), spec lands first so the contract,
...
- 🪶 ASF-specific automated release signing does not move the
  ...
  [`reproducibility.md`](/docs/release-management/reproducibility#automated-release-signing--asf-specific-optional).
...
[`process.md` § Label reference](/docs/release-management/process#label-reference)) is
...
- A prep PR (separate invocation), labelled `prep-pr-open`. On the
  ...
  [`reproducibility.md`](/docs/release-management/reproducibility#the-first-release-gitattributes-review).
...
verbatim, see the
[`projects/_template/release-build.md`](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md)
...
[RFC-AI-0004 Principle 6](/docs/rfcs/rfc-ai-0004#principle-6--privacy-by-design)).**
...
[RFC-AI-0004 Principle 4](/docs/rfcs/rfc-ai-0004#principle-4--conversational-correctable-agentic-skills)
...
- **Should `release-verify-rc` ship as an Agentic Pairing skill from day
  ...
  proposed ([`docs/modes.md` § Pairing](/docs/modes#pairing)); this
...
- **Agentic Autonomous eligibility for the prep PR's `-SNAPSHOT` bump
  ...
  file) but per
  [`docs/modes.md` § Agentic Autonomous](/docs/modes#agentic-autonomous),
...
- [`README.md`](/docs/release-management/readme), [`process.md`](/docs/release-management/process), within
  this family.
...
- [`docs/modes.md` § Drafting](/docs/modes#drafting), [§ Triage](/docs/modes#triage), modes the skills inhabit.
- [`docs/security/README.md`](/docs/security/readme), precedent
  for a multi-skill ASF-process family with shared state-change
  discipline.
- [`docs/mentoring/spec.md`](/docs/mentoring/spec), precedent for
  spec-before-code.
- [`docs/rfcs/RFC-AI-0004.md`](/docs/rfcs/rfc-ai-0004), the
