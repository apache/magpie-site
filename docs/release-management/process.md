...
Rendered page: https://magpie.apache.org/docs/release-management/process/

Source: https://github.com/apache/magpie/blob/main/docs/release-management/process.md
...
skills](https://github.com/apache/magpie/tree/main/skills/) execute against. The
[family README](/docs/release-management/readme) lists the skills; this document is the
process they share. The [spec](/docs/release-management/spec) defines per-skill scope,
...
([spec § Cross-cutting commitments](/docs/release-management/spec#cross-cutting-commitments))
...
- **The agent never holds, invokes, or proxies the Release
  ...
  satisfies [RFC-AI-0004 Principle 1](/docs/rfcs/rfc-ai-0004#principle-1--human-in-the-loop-on-every-state-change).
...
outstanding. See
[`reproducibility.md` § The first-release `.gitattributes` review](/docs/release-management/reproducibility#the-first-release-gitattributes-review).
...
2. Build invocation. The **source artefact** is, by default, a
   ...
   one by one in
   [`<project-config>/release-build.md` § Convenience artefacts](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md);
...
- **Reproducibility** (optional, per
  [`<project-config>/release-build.md` § Reproducibility checks](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md);
...
[`<project-config>/pmc-roster.md`](https://github.com/apache/magpie/blob/main/projects/_template/pmc-roster.md)
...
([`release-build.md` § Convenience artefacts](https://github.com/apache/magpie/blob/main/projects/_template/release-build.md)),
...
set (see [`release-promote` § hand-off](/docs/release-management/spec#release-promote)).
...
- **Site-bump PR** updating the project website's download page,
  ...
  [`<project-config>/site-repo.md`](https://github.com/apache/magpie/blob/main/projects/_template/site-repo.md);
  a committer merges.
...
- [`README.md`](/docs/release-management/readme), family overview, skill table.
- [`spec.md`](/docs/release-management/spec), per-skill scope, state-change boundary,
  hand-off protocol, adopter knobs.
- [`projects/_template/release-management-config.md`](https://github.com/apache/magpie/blob/main/projects/_template/release-management-config.md), adopter contract scaffold.
- [`reproducibility.md`](/docs/release-management/reproducibility), the reproducible source
...
- [`docs/modes.md` § Drafting](/docs/modes#drafting),
  [`§ Triage`](/docs/modes#triage), the modes the skills inhabit.
...
- [`docs/rfcs/RFC-AI-0004.md` § Principle 1](/docs/rfcs/rfc-ai-0004#principle-1--human-in-the-loop-on-every-state-change), the human-in-the-loop rule every state-change boundary in
