...
![Claude Code showing the magpie-release-management plugin installed and enabled](/docs-assets/quickstart/families/release-management-install.png)
...
workflow files in
[`<project-config>/`](https://github.com/apache/magpie/tree/main/projects/_template/), see the
adopter scaffold's
[`README.md`](https://github.com/apache/magpie/blob/main/projects/_template/README.md) for the
