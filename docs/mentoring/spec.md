...
Rendered page: https://magpie.apache.org/docs/mentoring/spec/

Source: https://github.com/apache/magpie/blob/main/docs/mentoring/spec.md
...
| Skill | Purpose |
|---|---|
| [`pr-management-mentor`](https://github.com/apache/magpie/blob/main/skills/pr-management-mentor/SKILL.md) | Draft a teaching-register comment on a single GitHub issue or PR thread. |
| [`good-first-issue-author`](https://github.com/apache/magpie/blob/main/skills/good-first-issue-author/SKILL.md) | Draft a single net-new good first issue from a maintainer-supplied candidate. |
| [`mentoring-welcome`](https://github.com/apache/magpie/blob/main/skills/mentoring-welcome/SKILL.md) | Draft a first-contact orientation comment for a first-time contributor on a newly opened issue or PR. |
| [`contributor-to-committer`](https://github.com/apache/magpie/blob/main/skills/contributor-to-committer/SKILL.md) | Read-only readiness tracker mapping a contributor's GitHub activity against the adopter's declared committer/PMC thresholds. (`family: contributor-growth` — cross-listed here for the mentoring path continuity.) |
| [`good-first-issue-sweep`](https://github.com/apache/magpie/blob/main/skills/good-first-issue-sweep/SKILL.md) | Sweep the open issue backlog for issues that could be labelled as good first issues, scoring each against the G1–G7 suitability rubric. |
| [`newcomer-issue-explainer`](https://github.com/apache/magpie/blob/main/skills/newcomer-issue-explainer/SKILL.md) | Explain an open good-first-issue in beginner terms and sketch a concrete approach (file pointers, done-definition, where to ask); an assessment gate declines closed, security-sensitive, or scope-unclear issues; nothing is posted without maintainer confirmation. |
...
See [`MISSION.md` § Agentic Mentoring](https://github.com/apache/magpie/blob/main/MISSION.md#technical-scope) and
...
- *Triage routing*. That is Agentic Triage's
  [`pr-management-triage`](https://github.com/apache/magpie/blob/main/skills/pr-management-triage/SKILL.md)
...
See the template at
[`projects/_template/mentoring-config.md`](https://github.com/apache/magpie/blob/main/projects/_template/mentoring-config.md).
Required keys:
...
- [`.claude/skills/pr-management-triage/comment-templates.md`](https://github.com/apache/magpie/blob/main/skills/pr-management-triage/comment-templates.md) —
