...
Rendered page: https://magpie.apache.org/docs/prerequisites/

Source: https://github.com/apache/magpie/blob/main/docs/prerequisites.md
...
- **[OpenAI Codex](https://github.com/openai/codex)** reads Magpie's
  ...
  recorded; see [the Codex runtime guide](/docs/adapters/codex).
...
[`<project-config>/project.md → Mail sources`](/docs/<project-config>/project#mail-sources)),
...
see
[`<project-config>/release-trains.md`](/docs/<project-config>/release-trains#security-team-roster).
...
[`<project-config>/project.md → CVE tooling`](/docs/<project-config>/project#cve-tooling).
...
- the adopting project's dev toolchain installed per
  [`<project-config>/fix-workflow.md → Toolchain`](/docs/<project-config>/fix-workflow#toolchain);
...
manifest's
[`project_metadata`](/docs/<project-config>/project#project-metadata)
