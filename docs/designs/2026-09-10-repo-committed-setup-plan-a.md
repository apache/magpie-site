...
Rendered page: https://magpie.apache.org/docs/designs/2026-09-10-repo-committed-setup-plan-a/

Source: https://github.com/apache/magpie/blob/main/docs/designs/2026-09-10-repo-committed-setup-plan-a.md
...
**Spec:** [`2026-09-10-repo-committed-setup-design.md`](/docs/designs/2026-09-10-repo-committed-setup-design)
...
- **Some but not all present** — report drift, name the missing members, and
  ...
  [`install.md`](/docs/designs/install#merge-rules). This is the case a framework release
...
see [the default set](/docs/designs/setup/marketplaces#claude-code-the-default-set).
