...
Rendered page: https://magpie.apache.org/docs/designs/2026-09-10-repo-committed-setup-design/

Source: https://github.com/apache/magpie/blob/main/docs/designs/2026-09-10-repo-committed-setup-design.md
...
1. **The default plugin set is documentation only.** The
   ...
   [`docs/setup/marketplaces.md`](/docs/setup/marketplaces). No code path
...
- **[`docs/quick-start.md`](/docs/quick-start)** gains a subsection under
  ...
  next*.
- **[`docs/setup/marketplaces.md`](/docs/setup/marketplaces)** — the
