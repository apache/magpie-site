...
Rendered page: https://magpie.apache.org/docs/contributor-sentiment/

Source: https://github.com/apache/magpie/blob/main/docs/contributor-sentiment.md
...
> [RFC-AI-0004](/docs/rfcs/rfc-ai-0004) and
> [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md). It is the gate that any Magpie-assisted
...
[adapters registry](/docs/adapters/registry) for setup instructions.
...
The [`contributor-sentiment`](https://github.com/apache/magpie/blob/main/skills/contributor-sentiment/SKILL.md)
...
- [RFC-AI-0004](/docs/rfcs/rfc-ai-0004) § Principle 1 — the gate that requires
  this evaluation before any Agentic Autonomous advancement.
- [MISSION.md](https://github.com/apache/magpie/blob/main/MISSION.md) § Initial Goals — the v1 requirement to
  settle on a contributor-sentiment methodology covering both ASF and
  non-ASF cohorts.
- [`docs/pilot-report-template.md`](/docs/pilot-report-template) — the
...
- [`skills/contributor-sentiment/SKILL.md`](https://github.com/apache/magpie/blob/main/skills/contributor-sentiment/SKILL.md) — the
  skill that runs the measurement and produces the gate-readable report.
- [`docs/contributor-growth/README.md`](/docs/contributor-growth/readme) — the
  contributor-growth family overview; this gate is the promotion evidence
  for those skills.
- [`docs/modes.md`](/docs/modes) — the experimental/stable status labels and
  what they mean.
