...
Rendered page: https://magpie.apache.org/docs/source-release-contents/

Source: https://github.com/apache/magpie/blob/main/docs/source-release-contents.md
...
[`.gitattributes`](https://github.com/apache/magpie/blob/main/.gitattributes). Alongside the framework source
...
[`release-management/reproducibility.md`](/docs/release-management/reproducibility).
...
[`.gitattributes`](https://github.com/apache/magpie/blob/main/.gitattributes) — VCS / CI / editor metadata that a
...
[`.gitattributes`](https://github.com/apache/magpie/blob/main/.gitattributes) is the authoritative list and
